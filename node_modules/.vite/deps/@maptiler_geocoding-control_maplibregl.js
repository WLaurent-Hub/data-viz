import {
  require_maplibre_gl
} from "./chunk-IPEINZ3G.js";
import {
  __toESM
} from "./chunk-WXXH56N5.js";

// node_modules/@maptiler/geocoding-control/maplibregl.js
var Bl = __toESM(require_maplibre_gl());
var Al = Object.defineProperty;
var Fl = (n21, t, e) => t in n21 ? Al(n21, t, { enumerable: true, configurable: true, writable: true, value: e }) : n21[t] = e;
var Cs = (n21, t, e) => (Fl(n21, typeof t != "symbol" ? t + "" : t, e), e);
var ha = (n21, t, e) => {
  if (!t.has(n21))
    throw TypeError("Cannot " + e);
};
var nr = (n21, t, e) => (ha(n21, t, "read from private field"), e ? e.call(n21) : t.get(n21));
var Is = (n21, t, e) => {
  if (t.has(n21))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n21) : t.set(n21, e);
};
var wo = (n21, t, e, r) => (ha(n21, t, "write to private field"), r ? r.call(n21, e) : t.set(n21, e), e);
function It() {
}
function kl(n21, t) {
  for (const e in t)
...
function Un(n21, t) {
  return n21 != n21 ? t == t : n21 !== t || n21 && typeof n21 == "object" || typeof n21 == "function";
}
var Po;
function me(n21, t) {
  return n21 === t ? true : (Po || (Po = document.createElement("a")), Po.href = t, n21 === Po.href);
}
function Gl(n21) {
  return Object.keys(n21).length === 0;
}
function zl(n21, t, e, r) {
  if (n21) {
    const i = pu(n21, t, e, r);
    return n21[0](i);
  }
}
function pu(n21, t, e, r) {
  return n21[1] && r ? kl(e.ctx.slice(), n21[1](r(t))) : e.ctx;
}
function Vl(n21, t, e, r) {
  if (n21[2] && r) {
    const i = n21[2](r(e));
    if (t.dirty === void 0)
      return i;
...
function ql(n21) {
  if (n21.ctx.length > 32) {
    const t = [], e = n21.ctx.length / 32;
    for (let r = 0; r < e; r++)
      t[r] = -1;
    return t;
  }
...
function Pt(n21, t, e) {
  n21.insertBefore(t, e || null);
}
function St(n21) {
  n21.parentNode && n21.parentNode.removeChild(n21);
}
function ht(n21) {
  return document.createElement(n21);
}
function Kr(n21) {
  return document.createElementNS("http://www.w3.org/2000/svg", n21);
}
function Rn(n21) {
  return document.createTextNode(n21);
}
function Xe() {
  return Rn(" ");
}
...
function Se(n21, t, e, r) {
  return n21.addEventListener(t, e, r), () => n21.removeEventListener(t, e, r);
}
function Yl(n21) {
  return function(t) {
    return t.preventDefault(), n21.call(this, t);
  };
}
function w(n21, t, e) {
  e == null ? n21.removeAttribute(t) : n21.getAttribute(t) !== e && n21.setAttribute(t, e);
}
function Wl(n21) {
  return Array.from(n21.childNodes);
}
function $i(n21, t) {
  t = "" + t, n21.data !== t && (n21.data = /** @type {string} */
  t);
}
function da(n21, t) {
  n21.value = t ?? "";
...
function ur(n21, t, e) {
  n21.classList.toggle(t, !!e);
}
function Hl(n21, t, { bubbles: e = false, cancelable: r = false } = {}) {
  return new CustomEvent(n21, { detail: t, bubbles: e, cancelable: r });
}
var to;
function Zi(n21) {
  to = n21;
...
function jl(n21) {
  du().$$.on_destroy.push(n21);
}
function Ql() {
  const n21 = du();
  return (t, e, { cancelable: r = false } = {}) => {
    const i = n21.$$.callbacks[t];
    if (i) {
      const o = Hl(
        /** @type {string} */
        t,
...
function vu() {
  ...
  do {
    ...
    for (Zi(null), mi.length = 0, vi = 0; ws.length; )
      ws.pop()();
  ...
  for (; ma.length; )
    ma.pop()();
  Ps = false, Ns.clear(), Zi(n21);
}
function Jl(n21) {
  if (n21.fragment !== null) {
    n21.update(), Cn(n21.before_update);
    const t = n21.dirty;
    n21.dirty = [-1], n21.fragment && n21.fragment.p(n21.ctx, t), n21.after_update.forEach(Rs);
  }
}
function $l(n21) {
  const t = [], e = [];
  _i.forEach((r) => n21.indexOf(r) === -1 ? t.push(r) : e.push(r)), e.forEach((r) => r()), _i = t;
}
...
function Ft(n21, t) {
  n21 && n21.i && (Fo.delete(n21), n21.i(t));
}
function ee(n21, t, e, r) {
  if (n21 && n21.o) {
    if (Fo.has(n21))
      return;
    Fo.add(n21), jn.c.push(() => {
      Fo.delete(n21), r && (e && n21.d(1), r());
    }), n21.o(t);
  } else
    r && r();
}
function ya(n21) {
  return (n21 == null ? void 0 : n21.length) !== void 0 ? n21 : Array.from(n21);
}
function tc(n21, t) {
  ee(n21, 1, 1, () => {
    t.delete(n21.key);
...
function ec(n21, t, e, r, i, o, s, a, u, l, c, f) {
  let h = n21.length, g = o.length, p = h;
  const v = {};
  for (; p--; )
    v[n21[p].key] = p;
  const d = [], y = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), C = [];
  for (p = g; p--; ) {
    const R = f(i, o, p), D = e(R);
    let b = s.get(D);
    b ? r && C.push(() => b.p(R, t)) : (b = l(D, R), b.c()), y.set(D, d[p] = b), D in v && I.set(D, Math.abs(p - v[D]));
  }
  ...
  for (; h && g; ) {
    const R = d[g - 1], D = n21[h - 1], b = R.key, A = D.key;
    R === D ? (c = R.first, h--, g--) : y.has(A) ? !s.has(b) || N.has(b) ? T(R) : L.has(A) ? h-- : I.get(b) > I.get(A) ? (L.add(b), T(R)) : (N.add(A), h--) : (u(D, s), h--);
  }
  for (; h--; ) {
    const R = n21[h];
    y.has(R.key) || u(R, s);
...
function cn(n21, t, e) {
  const { fragment: r, after_update: i } = n21.$$;
  r && r.m(t, e), Rs(() => {
    const o = n21.$$.on_mount.map(hu).filter(gu);
    n21.$$.on_destroy ? n21.$$.on_destroy.push(...o) : Cn(o), n21.$$.on_mount = [];
  }), i.forEach(Rs);
}
function fn(n21, t) {
  const e = n21.$$;
  e.fragment !== null && ($l(e.after_update), Cn(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function rc(n21, t) {
  n21.$$.dirty[0] === -1 && (mi.push(n21), Zl(), n21.$$.dirty.fill(0)), n21.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function qn(n21, t, e, r, i, o, s = null, a = [-1]) {
  const u = to;
  Zi(n21);
  const l = n21.$$ = {
    fragment: null,
  ...
  s && s(l.root);
  let c = false;
  if (l.ctx = e ? e(n21, t.props || {}, (f, h, ...g) => {
    const p = g.length ? g[0] : h;
    return l.ctx && i(l.ctx[f], l.ctx[f] = p) && (!l.skip_bound && l.bound[f] && l.bound[f](p), c && rc(n21, f)), h;
  }) : [], l.update(), c = true, Cn(l.before_update), l.fragment = r ? r(l.ctx) : false, t.target) {
    if (t.hydrate) {
      const f = Wl(t.target);
      l.fragment && l.fragment.l(f), f.forEach(St);
    } else
      l.fragment && l.fragment.c();
    t.intro && Ft(n21.$$.fragment), cn(n21, t.target, t.anchor), vu();
  }
  Zi(u);
}
var Xn = class {
   ...
   */
  $set(t) {
    this.$$set && !Gl(t) && (this.$$.skip_bound = true, this.$$set(t), this.$$.skip_bound = false);
  }
};
var nc = "4";
...
var yu = class extends Xn {
  constructor(t) {
    super(), qn(this, t, null, oc, Un, {});
  }
};
function sc(n21) {
  let t, e;
...
function lc(n21) {
  ...
  return {
    c() {
      t = ht("img"), me(t.src, e = /*iconsBaseUrl*/
      n21[3] + "postal_code.svg") || w(t, "src", e), w(
        t,
        "alt",
        /*placeType*/
        n21[6]
...
function hc(n21) {
  ...
  return {
    c() {
      t = ht("img"), me(t.src, e = /*iconsBaseUrl*/
      n21[3] + "housenumber.svg") || w(t, "src", e), w(
        t,
        "alt",
        /*placeType*/
        n21[6]
...
function pc(n21) {
  ...
  let t, e, r, i, o, s, a, u, l = (
    ...
    (n21[7] ? (
      ...
      /*feature*/
      n21[0].place_name.replace(/,.*/, "")
    )) + ""
  ), c, f, h = (
    /*showPlaceType*/
    n21[2] === "always" || /*showPlaceType*/
    n21[2] && !/*feature*/
    n21[0].address && /*feature*/
    ((R = n21[0].properties) == null ? void 0 : R.kind) !== "road" && /*feature*/
    ((D = n21[0].properties) == null ? void 0 : D.kind) !== "road_relation" && !/*feature*/
    n21[0].id.startsWith("address.") && !/*feature*/
    n21[0].id.startsWith("postal_code.") && (!/*feature*/
    n21[0].id.startsWith("poi.") || !/*imageUrl*/
    n21[5]) && !/*isReverse*/
    n21[7]
  ), g, p, v = (
    /*isReverse*/
  ...
  let N = C(n21, -1), L = N(n21), T = h && _a(n21);
  return {
    c() {
      t = ht("li"), L.c(), o = Xe(), s = ht("span"), a = ht("span"), u = ht("span"), c = Rn(l), f = Xe(), T && T.c(), g = Xe(), p = ht("span"), d = Rn(v), w(u, "class", "primary svelte-ltkwvy"), w(a, "class", "svelte-ltkwvy"), w(p, "class", "line2 svelte-ltkwvy"), w(s, "class", "texts svelte-ltkwvy"), w(t, "tabindex", "0"), w(
        t,
        "data-selected",
        /*selected*/
        n21[1]
      ), w(t, "class", "svelte-ltkwvy"), ur(
        t,
        "selected",
        /*selected*/
        n21[1]
    ...
    m(b, A) {
      Pt(b, t, A), L.m(t, null), it(t, o), it(t, s), it(s, a), it(a, u), it(u, c), it(a, f), T && T.m(a, null), it(s, g), it(s, p), it(p, d), y || (I = [
        Se(
          t,
          "mouseenter",
          /*mouseenter_handler*/
    ...
    p(b, [A]) {
      ...
      )) + "") && $i(c, l), A & /*showPlaceType, feature, imageUrl*/
      37 && (h = /*showPlaceType*/
      ...
      b[5]) && !/*isReverse*/
      b[7]), h ? T ? T.p(b, A) : (T = _a(b), T.c(), T.m(a, null)) : T && (T.d(1), T = null), A & /*feature*/
      1 && v !== (v = /*isReverse*/
      (b[7] ? "" : (
        /*feature*/
    ...
    o: It,
    d(b) {
      b && St(t), L.d(), T && T.d(), y = false, Cn(I);
    }
  };
}
function dc(n21, t, e) {
  var C;
  let r, i, { feature: o } = t, { selected: s = false } = t, { showPlaceType: a } = t, { missingIconsCache: u } = t, { iconsBaseUrl: l } = t;
  ...
  return n21.$$set = (N) => {
    ...
    var N, L, T, R;
    if (n21.$$.dirty & /*loadIconAttempt, index, category, iconsBaseUrl, imageUrl, missingIconsCache*/
    3640)
      do
...
var yc = class extends Xn {
  constructor(t) {
    super(), qn(this, t, null, mc, Un, {});
  }
};
function _c(n21) {
  let t, e, r;
  return {
    c() {
      t = Kr("svg"), e = Kr("path"), w(e, "stroke-width", "4"), w(e, "d", "M 5,33.103579 C 5,17.607779 18.457,5 35,5 C 51.543,5 65,17.607779 65,33.103579 C 65,56.388679 40.4668,76.048179 36.6112,79.137779 C 36.3714,79.329879 36.2116,79.457979 36.1427,79.518879 C 35.8203,79.800879 35.4102,79.942779 35,79.942779 C 34.5899,79.942779 34.1797,79.800879 33.8575,79.518879 C 33.7886,79.457979 33.6289,79.330079 33.3893,79.138079 C 29.5346,76.049279 5,56.389379 5,33.103579 Z M 35.0001,49.386379 C 43.1917,49.386379 49.8323,42.646079 49.8323,34.331379 C 49.8323,26.016779 43.1917,19.276479 35.0001,19.276479 C 26.8085,19.276479 20.1679,26.016779 20.1679,34.331379 C 20.1679,42.646079 26.8085,49.386379 35.0001,49.386379 Z"), w(e, "class", "svelte-gzo3ar"), w(t, "width", r = /*displayIn*/
      n21[0] === "list" ? 20 : void 0), w(t, "viewBox", "0 0 70 85"), w(t, "fill", "none"), w(t, "class", "svelte-gzo3ar"), ur(
        t,
        "in-map",
        /*displayIn*/
        n21[0] !== "list"
...
var Cc = class extends Xn {
  constructor(t) {
    super(), qn(this, t, Ec, _c, Un, { displayIn: 0 });
  }
};
function Ic(n21) {
  let t, e;
...
function Sc(n21) {
  ...
  return {
    c() {
      t = Kr("svg"), e = Kr("path"), w(e, "d", "M13.101 14.261 8.74 9.899a4.797 4.797 0 0 1-1.425.748 5.165 5.165 0 0 1-1.603.248c-1.446 0-2.677-.5-3.693-1.503S.495 7.164.495 5.717c0-1.446.508-2.678 1.524-3.693C3.035 1.008 4.266.5 5.712.5c1.448 0 2.672.508 3.675 1.524 1.002 1.015 1.503 2.247 1.503 3.693 0 .558-.08 1.092-.239 1.603-.159.512-.411.98-.757 1.405l4.382 4.4a.74.74 0 0 1 .229.568.81.81 0 0 1-.249.568.787.787 0 0 1-.577.239.787.787 0 0 1-.578-.239ZM5.712 9.223c.97 0 1.796-.342 2.48-1.026a3.378 3.378 0 0 0 1.026-2.48c0-.982-.34-1.818-1.016-2.509-.677-.69-1.507-1.035-2.49-1.035a3.42 3.42 0 0 0-2.509 1.035 3.42 3.42 0 0 0-1.035 2.51c0 .982.345 1.812 1.035 2.488.691.678 1.527 1.017 2.51 1.017Z"), w(t, "width", "14"), w(t, "height", "14"), w(t, "viewBox", "0 0 15 15"), w(t, "class", "svelte-en2qvf");
    },
    m(r, i) {
      Pt(r, t, i), it(t, e);
    },
...
function Lc(n21, t, e) {
  ...
  return n21 === r && e ? n21 : ((n21 - i) % o + o) % o + i;
}
function Ea(n21) {
  const t = [...n21];
...
var Wi;
async function bc(n21, t, e) {
  const r = n21 == null ? void 0 : n21.getCenterAndZoom();
  for (const i of t ?? [])
...
var Ca = /(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?/i;
var Ia = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?/i;
var Na = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?/i;
var Sa = /(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?/i;
function wc(n21) {
  if (!["DMS", "DM", "DD"].includes(n21))
    throw new Error("invalid format specified");
  if (this.decimalCoordinates && this.decimalCoordinates.trim()) {
    if (n21 == "DD")
      return this.decimalCoordinates;
    const t = this.decimalCoordinates.split(",").map((s) => Number(s.trim()));
    let e = xa(t[0], n21), r = xa(t[1], n21);
...
function xa(n21, t) {
  const e = Math.abs(n21), r = Math.floor(e), i = (e - r) * 60;
  if (t == "DM") {
...
function Pc(n21, t) {
  ...
  return Math.round((n21 + Number.EPSILON) * e) / e;
}
function Ys(n21, t) {
  t || (t = 5), n21 = n21.replace(/\s+/g, " ").trim();
  let e = null, r = null, i = "", o = "", s = [], a = false;
  if (Ca.test(n21))
    if (s = Ca.exec(n21), a = Ro(s), a) {
  ...
  if (a) {
    ...
    if (g == null) {
      const d = Math.floor(n21.length / 2);
      ...
      let y = 0;
      if (d == 0)
        y = l.indexOf(g[0]), c = l.substring(0, y).trim(), f = l.substring(y + 1).trim();
      else {
        let I = 0, C = 0;
        for (; I <= d; )
          y = l.indexOf(g[I], C), C = y + 1, I++;
        c = l.substring(0, y).trim(), f = l.substring(y + 1).trim();
      }
    }
    const p = c.split(".");
...
function Rc(n21) {
  if (n21.includes(",")) {
    ...
    return La(this.decimalLatitude, Number(t[0])) && La(this.decimalLongitude, t[1]);
  } else
...
function Fc() {
  const n21 = [];
  return Tc.forEach((t) => {
    t.decimalLatitude ? n21.push(t) : n21.push({ ...t, ...Dc });
  }), [...n21, ...Mc, ...Ac];
}
var Bc = Fc();
Ys.formats = Bc.map((n21) => n21.verbatimCoordinates);
var kc = Ys;
function ba(n21, t, e) {
  const r = n21.slice();
...
function wa(n21) {
  ...
  return t = new yc({}), {
    ...
    i(r) {
      e || (Ft(t.$$.fragment, r), e = true);
    },
    o(r) {
      ee(t.$$.fragment, r), e = false;
    },
    d(r) {
      fn(t, r);
    }
...
function Pa(n21) {
  ...
  return e = new Nc({}), {
    ...
    m(s, a) {
      Pt(s, t, a), cn(e, t, null), r = true, i || (o = Se(
        t,
        "click",
        /*click_handler_2*/
        n21[67]
    ...
    i(s) {
      r || (Ft(e.$$.fragment, s), r = true);
    },
    o(s) {
      ee(e.$$.fragment, s), r = false;
    },
    d(s) {
      s && St(t), fn(e), i = false, o();
    }
  };
}
function Gc(n21) {
  let t, e = [], r = /* @__PURE__ */ new Map(), i, o, s, a = ya(
    /*listFeatures*/
    n21[14]
  );
  const u = (l) => (
  ...
  return {
    ...
    p(l, c) {
      ...
      17880064 && (a = ya(
        /*listFeatures*/
        l[14]
      ), Bo(), e = ec(e, c, u, 1, l, a, r, t, tc, Ra, null, ba), ko());
    },
    i(l) {
      if (!i) {
...
function zc(n21) {
  ...
  return e = new yu({}), {
    c() {
      t = ht("div"), On(e.$$.fragment), r = Xe(), i = ht("div"), o = Rn(
        /*noResultsMessage*/
        n21[7]
      ), w(i, "class", "svelte-1r7dvt7"), w(t, "class", "no-results svelte-1r7dvt7");
    },
    m(a, u) {
      Pt(a, t, u), cn(e, t, null), it(t, r), it(t, i), it(i, o), s = true;
    },
    p(a, u) {
    ...
    i(a) {
      s || (Ft(e.$$.fragment, a), s = true);
    },
    o(a) {
      ee(e.$$.fragment, a), s = false;
    },
    d(a) {
      a && St(t), fn(e);
    }
...
function Uc(n21) {
  ...
  return e = new yu({}), u = new mu({}), {
    c() {
      t = ht("div"), On(e.$$.fragment), r = Xe(), i = ht("div"), o = Rn(
        /*errorMessage*/
        n21[6]
      ), s = Xe(), a = ht("button"), On(u.$$.fragment), w(i, "class", "svelte-1r7dvt7"), w(a, "class", "svelte-1r7dvt7"), w(t, "class", "error svelte-1r7dvt7");
    },
    m(h, g) {
      Pt(h, t, g), cn(e, t, null), it(t, r), it(t, i), it(i, o), it(t, s), it(t, a), cn(u, a, null), l = true, c || (f = Se(
        a,
        "click",
        /*click_handler_3*/
        n21[68]
    ...
    i(h) {
      l || (Ft(e.$$.fragment, h), Ft(u.$$.fragment, h), l = true);
    },
    o(h) {
      ee(e.$$.fragment, h), ee(u.$$.fragment, h), l = false;
    },
    d(h) {
      h && St(t), fn(e), fn(u), c = false, f();
    }
  };
}
function Ra(n21, t) {
  ...
  return r = new vc({
    ...
    first: null,
    c() {
      e = Xl(), On(r.$$.fragment), this.first = e;
    },
    m(a, u) {
      Pt(a, e, u), cn(r, a, u), i = true;
    },
    p(a, u) {
      t = a;
      const l = {};
    ...
    i(a) {
      i || (Ft(r.$$.fragment, a), i = true);
    },
    o(a) {
      ee(r.$$.fragment, a), i = false;
    },
    d(a) {
      a && St(e), fn(r, a);
    }
...
function qc(n21) {
  let t, e, r, i, o, s, a, u, l, c, f, h, g, p, v, d, y, I, C, N, L, T = false;
  o = new xc({}), f = new mu({});
  let R = (
    /*abortController*/
    n21[19] && wa()
  ...
  return ~(d = at(n21)) && (y = G[d] = Y[d](n21)), {
    c() {
      t = Xe(), e = ht("form"), r = ht("div"), i = ht("button"), On(o.$$.fragment), s = Xe(), a = ht("input"), u = Xe(), l = ht("div"), c = ht("button"), On(f.$$.fragment), h = Xe(), R && R.c(), g = Xe(), D && D.c(), p = Xe(), A && A.c(), v = Xe(), y && y.c(), w(i, "class", "search-button svelte-1r7dvt7"), w(i, "type", "button"), w(
        a,
        "placeholder",
        /*placeholder*/
        n21[8]
        ...
        /*placeholder*/
        n21[8]
      ), w(a, "class", "svelte-1r7dvt7"), w(c, "type", "button"), w(
        c,
        "title",
        /*clearButtonTitle*/
        n21[3]
      ), w(c, "class", "svelte-1r7dvt7"), w(l, "class", "clear-button-container svelte-1r7dvt7"), ur(
        l,
        "displayable",
        /*searchValue*/
        n21[1] !== ""
      ), w(r, "class", "input-group svelte-1r7dvt7"), w(e, "tabindex", "0"), w(e, "class", I = pa(
        /*className*/
        n21[2]
      ) + " svelte-1r7dvt7"), ur(
        e,
    ...
    m(x, k) {
      Pt(x, t, k), Pt(x, e, k), it(e, r), it(r, i), cn(o, i, null), it(r, s), it(r, a), n21[61](a), da(
        a,
        /*searchValue*/
        n21[1]
      ), it(r, u), it(r, l), it(l, c), cn(f, c, null), it(l, h), R && R.m(l, null), it(r, g), D && D.m(r, null), it(r, p), A && A.m(r, null), it(e, v), ~d && G[d].m(e, null), C = true, N || (L = [
        Se(
          i,
          "click",
          /*click_handler*/
    ...
    p(x, k) {
      ...
      x[19] ? R ? k[0] & /*abortController*/
      524288 && Ft(R, 1) : (R = wa(), R.c(), Ft(R, 1), R.m(l, null)) : R && (Bo(), ee(R, 1, 1, () => {
        R = null;
      }), ko()), (!C || k[0] & /*searchValue*/
      2) && ur(
        l,
        "displayable",
        /*searchValue*/
      ...
      x[5] === true ? D ? (D.p(x, k), k[0] & /*enableReverse*/
      32 && Ft(D, 1)) : (D = Pa(x), D.c(), Ft(D, 1), D.m(r, p)) : D && (Bo(), ee(D, 1, 1, () => {
        D = null;
      }), ko()), A && A.p && (!C || k[1] & /*$$scope*/
      134217728) && Ul(
        A,
        b,
        x,
      ...
      let Q = d;
      d = at(x), d === Q ? ~d && G[d].p(x, k) : (y && (Bo(), ee(G[Q], 1, 1, () => {
        G[Q] = null;
      }), ko()), ~d ? (y = G[d], y ? y.p(x, k) : (y = G[d] = Y[d](x), y.c()), Ft(y, 1), y.m(e, null)) : y = null), (!C || k[0] & /*className*/
      4 && I !== (I = pa(
        /*className*/
        x[2]
      ) + " svelte-1r7dvt7")) && w(e, "class", I), (!C || k[0] & /*className, collapsed, searchValue*/
      22) && ur(
        e,
        "can-collapse",
        /*collapsed*/
    ...
    i(x) {
      C || (Ft(T), Ft(o.$$.fragment, x), Ft(f.$$.fragment, x), Ft(R), Ft(D), Ft(A, x), Ft(y), C = true);
    },
    o(x) {
      ee(T), ee(o.$$.fragment, x), ee(f.$$.fragment, x), ee(R), ee(D), ee(A, x), ee(y), C = false;
    },
    d(x) {
      x && (St(t), St(e)), fn(o), n21[61](null), fn(f), R && R.d(), D && D.d(), A && A.d(x), ~d && G[d].d(), N = false, Cn(L);
    }
  };
}
function Xc(n21, t, e) {
  let r, { $$slots: i = {}, $$scope: o } = t, { class: s = void 0 } = t, { apiKey: a } = t, { bbox: u = void 0 } = t, { clearButtonTitle: l = "clear" } = t, { clearOnBlur: c = false } = t, { collapsed: f = false } = t, { country: h = void 0 } = t, { debounceSearch: g = 200 } = t, { enableReverse: p = false } = t, { errorMessage: v = "Something went wrong…" } = t, { filter: d = () => true } = t, { flyTo: y = true } = t, { fuzzyMatch: I = true } = t, { language: C = void 0 } = t, { limit: N = void 0 } = t, { mapController: L = void 0 } = t, { minLength: T = 2 } = t, { noResultsMessage: R = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = t, { placeholder: D = "Search" } = t, { proximity: b = [{ type: "server-geolocation" }] } = t, { reverseActive: A = p === "always" } = t, { reverseButtonTitle: Y = "toggle reverse geocoding" } = t, { searchValue: G = "" } = t, { showFullGeometry: at = true } = t, { showPlaceType: x = "ifNeeded" } = t, { showResultsWhileTyping: k = true } = t, { selectFirst: Q = true } = t, { flyToSelected: _t = false } = t, { markerOnSelected: Kt = true } = t, { types: zt = void 0 } = t, { excludeTypes: kr = false } = t, { zoom: Ie = 16 } = t, { maxZoom: De = 18 } = t, { apiUrl: Ue = "https://api.maptiler.com/geocoding" } = t, { fetchParameters: In = {} } = t, { iconsBaseUrl: sn = "https://cdn.maptiler.com/maptiler-geocoding-control/v1.2.0/icons/" } = t, { adjustUrlQuery: gs = (S) => {
  } } = t;
  function pl() {
    Gr.focus();
  }
  ...
  function la(S, Ut = true) {
    e(1, G = S), Ut ? (e(15, Lt = -1), fa()) : (ms(), setTimeout(() => {
      Gr.focus(), Gr.select();
    }));
  }
  function vl() {
    e(14, nt = void 0), e(55, Z = void 0), e(15, Lt = -1);
  }
  function ml() {
    e(54, Vt = []), e(55, Z = void 0);
  }
  let pi = false, nt, Vt, Z, ca = "", Gr, Lt = -1, zr, So = [], Hn, di, xo, ps;
  const yl = /* @__PURE__ */ new Set(), Nn = Ql();
  jl(() => {
    L && (L.setEventHandler(void 0), L.indicateReverse(false), L.setSelectedMarker(-1), L.setMarkers(void 0, void 0));
  });
  function fa(S) {
    if (di && (clearTimeout(di), di = void 0), Lt > -1 && nt)
      e(55, Z = nt[Lt]), e(1, G = Z.place_type[0] === "reverse" ? Z.place_name : Z.place_name.replace(/,.*/, "")), e(18, zr = void 0), e(54, Vt = void 0), e(15, Lt = -1);
    else if (G) {
      const Ut = S || !ds(G);
      vs(G, { exact: true }).then(() => {
        e(54, Vt = nt), e(55, Z = void 0), Ut && _l();
      }).catch((Vr) => e(18, zr = Vr));
    }
  }
  function ds(S) {
  ...
  async function vs(S, { byId: Ut = false, exact: Vr = false } = {}) {
    e(18, zr = void 0), Hn == null || Hn.abort();
    const Ur = new AbortController();
    e(19, Hn = Ur);
    try {
      const ot = ds(S), rr = new URLSearchParams();
      if (C !== void 0 && rr.set("language", Array.isArray(C) ? C.join(",") : C ?? ""), zt && rr.set("types", zt.join(",")), kr && rr.set("excludeTypes", String(kr)), u && rr.set("bbox", u.map((bo) => bo.toFixed(6)).join(",")), h && rr.set("country", Array.isArray(h) ? h.join(",") : h), !Ut && !ot) {
        const bo = await bc(L, b, Ur);
        bo && rr.set("proximity", bo), (Vr || !k) && rr.set("autocomplete", "false"), rr.set("fuzzyMatch", String(I));
      }
      N !== void 0 && (!ot || (zt == null ? void 0 : zt.length) === 1) && rr.set("limit", String(N)), rr.set("key", a), gs(rr);
      const Lo = Ue + "/" + encodeURIComponent(ot ? ot.decimalLongitude + "," + ot.decimalLatitude : S) + ".json?" + rr.toString();
      if (Lo === ca) {
        Ut ? (e(14, nt = void 0), e(55, Z = So[0])) : e(14, nt = So);
        return;
      }
      ca = Lo;
      const _s = await fetch(Lo, { signal: Ur.signal, ...In });
      if (!_s.ok)
        throw new Error(await _s.text());
      const Es = await _s.json();
      Nn("response", { url: Lo, featureCollection: Es }), Ut ? (e(14, nt = void 0), e(55, Z = Es.features[0]), So = [Z]) : (e(14, nt = Es.features.filter(d)), ot && nt.unshift({
        type: "Feature",
        properties: {},
      ...
      Ur === Hn && e(19, Hn = void 0);
    }
  }
  function _l() {
    var Vr;
    if (!(Vt != null && Vt.length) || !y)
      return;
    const S = [180, 90, -180, -90], Ut = !Vt.some((Ur) => !Ur.matching_text);
    for (const Ur of Vt)
      if (Ut || !Ur.matching_text)
        for (const ot of [0, 1, 2, 3])
          S[ot] = Math[ot < 2 ? "min" : "max"](S[ot], ((Vr = Ur.bbox) == null ? void 0 : Vr[ot]) ?? Ur.center[ot % 2]);
    L && Vt.length > 0 && (Z && S[0] === S[2] && S[1] === S[3] ? L.flyTo(Z.center, Ie) : L.fitBounds(Ea(S), 50, De));
  }
  function El(S) {
    e(0, A = p === "always"), e(14, nt = void 0), e(55, Z = void 0), e(15, Lt = -1), la(S[1].toFixed(6) + ", " + Lc(S[0], [-180, 180], true).toFixed(6), false);
  }
  function Cl(S) {
    if (!nt)
      return;
    let Ut = S.key === "ArrowDown" ? 1 : S.key === "ArrowUp" ? -1 : 0;
    Ut && (Lt === (Q ? 0 : -1) && Ut === -1 && e(15, Lt = nt.length), e(15, Lt += Ut), Lt >= nt.length && e(15, Lt = -1), Lt < 0 && Q && e(15, Lt = 0), S.preventDefault());
  }
  function ms(S = true) {
    if (e(18, zr = void 0), k) {
      ...
      di = window.setTimeout(
        () => {
          vs(Ut).catch((Vr) => e(18, zr = Vr));
        },
        S ? g : 0
      );
    } else
      e(14, nt = void 0), e(18, zr = void 0);
  }
  function ys(S) {
  ...
  const xl = () => e(13, pi = true), Ll = () => e(13, pi = false), bl = () => ms(), wl = () => {
    e(1, G = ""), Gr.focus();
  }, Pl = () => e(0, A = !A), Rl = () => e(18, zr = void 0), Ol = (S) => e(15, Lt = S), Tl = (S) => ys(S), Dl = () => {
    Q || e(15, Lt = -1);
  }, Ml = () => {
  };
  return n21.$$set = (S) => {
    "class" in S && e(2, s = S.class), "apiKey" in S && e(25, a = S.apiKey), "bbox" in S && e(26, u = S.bbox), "clearButtonTitle" in S && e(3, l = S.clearButtonTitle), "clearOnBlur" in S && e(27, c = S.clearOnBlur), "collapsed" in S && e(4, f = S.collapsed), "country" in S && e(28, h = S.country), "debounceSearch" in S && e(29, g = S.debounceSearch), "enableReverse" in S && e(5, p = S.enableReverse), "errorMessage" in S && e(6, v = S.errorMessage), "filter" in S && e(30, d = S.filter), "flyTo" in S && e(31, y = S.flyTo), "fuzzyMatch" in S && e(32, I = S.fuzzyMatch), "language" in S && e(33, C = S.language), "limit" in S && e(34, N = S.limit), "mapController" in S && e(35, L = S.mapController), "minLength" in S && e(36, T = S.minLength), "noResultsMessage" in S && e(7, R = S.noResultsMessage), "placeholder" in S && e(8, D = S.placeholder), "proximity" in S && e(37, b = S.proximity), "reverseActive" in S && e(0, A = S.reverseActive), "reverseButtonTitle" in S && e(9, Y = S.reverseButtonTitle), "searchValue" in S && e(1, G = S.searchValue), "showFullGeometry" in S && e(38, at = S.showFullGeometry), "showPlaceType" in S && e(10, x = S.showPlaceType), "showResultsWhileTyping" in S && e(39, k = S.showResultsWhileTyping), "selectFirst" in S && e(11, Q = S.selectFirst), "flyToSelected" in S && e(40, _t = S.flyToSelected), "markerOnSelected" in S && e(41, Kt = S.markerOnSelected), "types" in S && e(42, zt = S.types), "excludeTypes" in S && e(43, kr = S.excludeTypes), "zoom" in S && e(44, Ie = S.zoom), "maxZoom" in S && e(45, De = S.maxZoom), "apiUrl" in S && e(46, Ue = S.apiUrl), "fetchParameters" in S && e(47, In = S.fetchParameters), "iconsBaseUrl" in S && e(12, sn = S.iconsBaseUrl), "adjustUrlQuery" in S && e(48, gs = S.adjustUrlQuery), "$$scope" in S && e(58, o = S.$$scope);
  }, n21.$$.update = () => {
    if (n21.$$.dirty[0] & /*focused, clearOnBlur*/
    134225920 && setTimeout(() => {
      e(16, xo = pi), c && !pi && e(1, G = "");
    }), n21.$$.dirty[0] & /*searchValue, listFeatures*/
    16386 | n21.$$.dirty[1] & /*minLength*/
    32 && G.length < T && (e(55, Z = void 0), e(14, nt = void 0), e(18, zr = void 0), e(54, Vt = nt)), n21.$$.dirty[1] & /*showFullGeometry, picked*/
    16777344 && at && Z && !Z.address && Z.geometry.type === "Point" && Z.place_type[0] !== "reverse" && vs(Z.id, { byId: true }).catch((S) => e(18, zr = S)), n21.$$.dirty[1] & /*mapController, picked, prevIdToFly, flyTo, maxZoom, zoom*/
    50356241 && (L && Z && Z.id !== ps && y && (!Z.bbox || Z.bbox[0] === Z.bbox[2] && Z.bbox[1] === Z.bbox[3] ? L.flyTo(Z.center, Z.id.startsWith("poi.") || Z.id.startsWith("address.") ? De : Ie) : L.fitBounds(Ea(Z.bbox), 50, De), e(14, nt = void 0), e(54, Vt = void 0), e(15, Lt = -1)), e(56, ps = Z == null ? void 0 : Z.id)), n21.$$.dirty[0] & /*selectFirst, listFeatures*/
    18432 && Q && nt != null && nt.length && e(15, Lt = 0), n21.$$.dirty[0] & /*selectFirst, searchValue*/
    2050 && (Q || e(15, Lt = -1)), n21.$$.dirty[0] & /*listFeatures*/
    16384 | n21.$$.dirty[1] & /*markedFeatures*/
    8388608 && Vt !== nt && e(54, Vt = void 0), n21.$$.dirty[0] & /*reverseActive, listFeatures, focusedDelayed*/
    81921 | n21.$$.dirty[1] & /*mapController, markedFeatures*/
    8388624 && L && L.setEventHandler((S) => {
      switch (S.type) {
        ...
        case "markerClick":
          {
            const Ut = nt == null ? void 0 : nt.find((Vr) => Vr.id === S.id);
            Ut && ys(Ut);
          }
          break;
        case "markerMouseEnter":
          Vt && e(15, Lt = xo ? (nt == null ? void 0 : nt.findIndex((Ut) => Ut.id === S.id)) ?? -1 : -1);
          break;
        case "markerMouseLeave":
          Vt && e(15, Lt = -1);
          break;
      }
    }), n21.$$.dirty[0] & /*listFeatures, selectedItemIndex*/
    49152 && e(57, r = nt == null ? void 0 : nt[Lt]), n21.$$.dirty[1] & /*mapController, selected, flyTo, flyToSelected, maxZoom, zoom*/
    67133969 && L && r && y && _t && L.flyTo(r.center, r.id.startsWith("poi.") || r.id.startsWith("address.") ? De : Ie), n21.$$.dirty[1] & /*markerOnSelected, mapController*/
    1040 && (Kt || L == null || L.setMarkers(void 0, void 0)), n21.$$.dirty[1] & /*mapController, markerOnSelected, markedFeatures, selected*/
    75498512 && L && Kt && !Vt && (L.setMarkers(r ? [r] : void 0, void 0), L.setSelectedMarker(r ? 0 : -1)), n21.$$.dirty[1] & /*mapController, markedFeatures, picked*/
    25165840 && L && L.setMarkers(Vt, Z), n21.$$.dirty[0] & /*selectedItemIndex*/
    32768 | n21.$$.dirty[1] & /*markedFeatures, mapController*/
    8388624 && Vt && L && L.setSelectedMarker(Lt), n21.$$.dirty[0] & /*searchValue*/
    2 | n21.$$.dirty[1] & /*mapController*/
    16 && L) {
      const S = ds(G);
      L.setReverseMarker(S ? [S.decimalLongitude, S.decimalLatitude] : void 0);
    }
    n21.$$.dirty[1] & /*selected*/
    67108864 && Nn("select", r), n21.$$.dirty[1] & /*picked*/
    16777216 && Nn("pick", Z), n21.$$.dirty[0] & /*focusedDelayed, listFeatures*/
    81920 && Nn("optionsVisibilityChange", xo && !!nt), n21.$$.dirty[0] & /*listFeatures*/
    16384 && Nn("featuresListed", nt), n21.$$.dirty[1] & /*markedFeatures*/
    8388608 && Nn("featuresMarked", Vt), n21.$$.dirty[0] & /*reverseActive*/
    1 && Nn("reverseToggle", A), n21.$$.dirty[0] & /*searchValue*/
    2 && Nn("queryChange", G), n21.$$.dirty[0] & /*reverseActive*/
    1 | n21.$$.dirty[1] & /*mapController*/
...
function jc(n21, t, e) {
  return t === null ? n21 : (n21 === null || (t = Ln(n21.key, t, e), t.left = n21), t);
}
function Os(n21, t, e, r, i) {
  if (n21) {
    r("" + t + (e ? "└── " : "├── ") + i(n21) + `
`);
    var o = t + (e ? "    " : "│   ");
    n21.left && Os(n21.left, o, false, r, i), n21.right && Os(n21.right, o, true, r, i);
  }
}
var Ws = (
  /** @class */
  function() {
    ...
    return n21.prototype.insert = function(t, e) {
      return this._size++, this._root = Ss(t, e, this._root, this._comparator);
    }, n21.prototype.add = function(t, e) {
      var r = new Tn(t, e);
    ...
    }, n21.prototype.remove = function(t) {
      this._root = this._remove(t, this._root, this._comparator);
    }, n21.prototype._remove = function(t, e, r) {
      var i;
      if (e === null)
        return null;
      e = Ln(t, e, r);
      ...
      return null;
    }, n21.prototype.findStatic = function(t) {
      ...
      return false;
    }, n21.prototype.forEach = function(t, e) {
      for (var r = this._root, i = [], o = false; !o; )
        r !== null ? (i.push(r), r = r.left) : i.length !== 0 ? (r = i.pop(), t.call(e, r), r = r.right) : o = true;
      return this;
    }, n21.prototype.range = function(t, e, r, i) {
      ...
      return this;
    }, n21.prototype.keys = function() {
      var t = [];
      return this.forEach(function(e) {
        var r = e.key;
        return t.push(r);
      }), t;
    }, n21.prototype.values = function() {
      var t = [];
      return this.forEach(function(e) {
        var r = e.data;
        return t.push(r);
      }), t;
    }, n21.prototype.min = function() {
      return this._root ? this.minNode(this._root).key : null;
    }, n21.prototype.max = function() {
      return this._root ? this.maxNode(this._root).key : null;
    }, n21.prototype.minNode = function(t) {
      if (t === void 0 && (t = this._root), t)
        for (; t.left; )
          t = t.left;
      return t;
    }, n21.prototype.maxNode = function(t) {
      if (t === void 0 && (t = this._root), t)
        for (; t.right; )
          t = t.right;
      return t;
    }, n21.prototype.at = function(t) {
      for (var e = this._root, r = false, i = 0, o = []; !r; )
        if (e)
          o.push(e), e = e.left;
        else if (o.length > 0) {
          if (e = o.pop(), i === t)
      ...
      return r;
    }, n21.prototype.clear = function() {
      return this._root = null, this._size = 0, this;
    }, n21.prototype.toList = function() {
      return Kc(this._root);
    }, n21.prototype.load = function(t, e, r) {
      e === void 0 && (e = []), r === void 0 && (r = false);
      var i = t.length, o = this._comparator;
      if (r && Ms(t, e, 0, i - 1, o), this._root === null)
        this._root = Ts(t, e, 0, i), this._size = i;
      else {
        var s = Zc(this.toList(), Qc(t, e), o);
        i = this._size + i, this._root = Ds({ head: s }, 0, i);
      }
      return this;
    }, n21.prototype.isEmpty = function() {
      return this._root === null;
    }, Object.defineProperty(n21.prototype, "size", {
      get: function() {
        return this._size;
      },
      enumerable: true,
      configurable: true
    }), Object.defineProperty(n21.prototype, "root", {
      get: function() {
        return this._root;
      },
      enumerable: true,
      configurable: true
    }), n21.prototype.toString = function(t) {
      t === void 0 && (t = function(r) {
        return String(r.key);
      });
      var e = [];
      return Os(this._root, "", true, function(r) {
        return e.push(r);
      }, t), e.join("");
    }, n21.prototype.update = function(t, e, r) {
      var i = this._comparator, o = Oa(t, this._root, i), s = o.left, a = o.right;
      i(t, e) < 0 ? a = Ss(e, r, a, i) : s = Ss(e, r, s, i), this._root = jc(s, a, i);
    }, n21.prototype.split = function(t) {
      return Oa(t, this._root, this._comparator);
    }, n21.prototype[Symbol.iterator] = function() {
      var t, e, r;
      return Wc(this, function(i) {
        switch (i.label) {
          case 0:
            t = this._root, e = [], r = false, i.label = 1;
          case 1:
...
function Ts(n21, t, e, r) {
  var i = r - e;
  if (i > 0) {
    var o = e + Math.floor(i / 2), s = n21[o], a = t[o], u = new Tn(s, a);
    return u.left = Ts(n21, t, e, o), u.right = Ts(n21, t, o + 1, r), u;
  }
  return null;
}
function Qc(n21, t) {
  for (var e = new Tn(null, null), r = e, i = 0; i < n21.length; i++)
    r = r.next = new Tn(n21[i], t[i]);
  return r.next = null, e.next;
}
function Kc(n21) {
  for (var t = n21, e = [], r = false, i = new Tn(null, null), o = i; !r; )
    t ? (e.push(t), t = t.left) : e.length > 0 ? (t = o = o.next = e.pop(), t = t.right) : r = true;
  return o.next = null, i.next;
}
function Ds(n21, t, e) {
  var r = e - t;
  if (r > 0) {
    var i = t + Math.floor(r / 2), o = Ds(n21, t, i), s = n21.head;
    return s.left = o, n21.head = n21.head.next, s.right = Ds(n21, i + 1, e), s;
  }
  return null;
}
function Zc(n21, t, e) {
  for (var r = new Tn(null, null), i = r, o = n21, s = t; o !== null && s !== null; )
    e(o.key, s.key) < 0 ? (i.next = o, o = o.next) : (i.next = s, s = s.next), i = i.next;
  return o !== null ? i.next = o : s !== null && (i.next = s), r.next;
}
function Ms(n21, t, e, r, i) {
  if (!(e >= r)) {
    for (var o = n21[e + r >> 1], s = e - 1, a = r + 1; ; ) {
      do
        s++;
      while (i(n21[s], o) < 0);
      do
      ...
      if (s >= a)
        break;
      var u = n21[s];
      n21[s] = n21[a], n21[a] = u, u = t[s], t[s] = t[a], t[a] = u;
    }
    Ms(n21, t, e, a, i), Ms(n21, t, a + 1, r, i);
  }
}
function Cr(n21, t) {
  if (!(n21 instanceof t))
...
function Ta(n21, t) {
  for (var e = 0; e < t.length; e++) {
    var r = t[e];
    r.enumerable = r.enumerable || false, r.configurable = true, "value" in r && (r.writable = true), Object.defineProperty(n21, r.key, r);
  }
}
function be(n21, t, e) {
  return t && Ta(n21.prototype, t), e && Ta(n21, e), n21;
}
var Hi = function(t, e) {
...
var Da = function() {
  function n21() {
    Cr(this, n21), this.tree = new Ws(), this.round(0);
  }
  return be(n21, [{
    key: "round",
    value: function(e) {
      var r = this.tree.add(e), i = this.tree.prev(r);
      if (i !== null && Fs(r.key, i.key) === 0)
        return this.tree.remove(e), i.key;
      var o = this.tree.next(r);
      return o !== null && Fs(r.key, o.key) === 0 ? (this.tree.remove(e), o.key) : e;
    }
  }]), n21;
}();
var eo = new $c();
...
var rf = function(t, e, r, i) {
  ...
  var s = {
    x: r.x - t.x,
    y: r.y - t.y
  }, a = Ji(s, e) / o, u = Ji(s, i) / o, l = t.x + u * e.x, c = r.x + a * i.x, f = t.y + u * e.y, h = r.y + a * i.y, g = (l + c) / 2, p = (f + h) / 2;
  return {
    x: g,
    y: p
  };
...
var Wr = function() {
  be(n21, null, [{
    ...
    value: function(e, r) {
      var i = n21.comparePoints(e.point, r.point);
  ...
  function n21(t, e) {
    Cr(this, n21), t.events === void 0 ? t.events = [this] : t.events.push(this), this.point = t, this.isLeft = e;
  }
  return be(n21, [{
    key: "link",
    value: function(e) {
...
var Uo = function() {
  ...
  function n21(t, e, r, i) {
    Cr(this, n21), this.id = ++nf, this.leftSE = t, t.segment = this, t.otherSE = e, this.rightSE = e, e.segment = this, e.otherSE = t, this.rings = r, this.windings = i;
  }
  return be(n21, [{
    key: "replaceRightSE",
    ...
    key: "getIntersection",
    value: function(e) {
      var r = this.bbox(), i = e.bbox(), o = As(r, i);
      if (o === null)
        return null;
      var s = this.leftSE.point, a = this.rightSE.point, u = e.leftSE.point, l = e.rightSE.point, c = Hi(r, u) && this.comparePoint(u) === 0, f = Hi(i, s) && e.comparePoint(s) === 0, h = Hi(r, l) && this.comparePoint(l) === 0, g = Hi(i, a) && e.comparePoint(a) === 0;
      if (f && c)
    ...
    key: "split",
    value: function(e) {
      var r = [], i = e.events !== void 0, o = new Wr(e, true), s = new Wr(e, false), a = this.rightSE;
      this.replaceRightSE(s), r.push(s), r.push(o);
      var u = new n21(o, a, this.rings.slice(), this.windings.slice());
      return Wr.comparePoints(u.leftSE.point, u.rightSE.point) > 0 && u.swapEvents(), Wr.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), i && (o.checkForConsuming(), s.checkForConsuming()), r;
    }
    ...
    value: function(e, r, i) {
      var o, s, a, u = Wr.comparePoints(e, r);
      if (u < 0)
        o = e, s = r, a = 1;
      else if (u > 0)
        o = r, s = e, a = -1;
      ...
      var l = new Wr(o, true), c = new Wr(s, false);
      return new n21(l, c, [i], [a]);
    }
  }]), n21;
}();
var Ba = function() {
  function n21(t, e, r) {
    if (Cr(this, n21), !Array.isArray(t) || t.length === 0)
...
var of = function() {
  function n21(t, e) {
    if (Cr(this, n21), !Array.isArray(t))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Ba(t[0], this, true), this.bbox = {
      ll: {
        ...
        if (!(!s.isInResult() || s.ringOut)) {
          for (var a = null, u = s.leftSE, l = s.rightSE, c = [u], f = u.point, h = []; a = u, u = l, c.push(u), u.point !== f; )
            for (; ; ) {
              ...
              for (var d = null, y = 0, I = h.length; y < I; y++)
                if (h[y].point === u.point) {
                  d = y;
                  break;
                }
              if (d !== null) {
                var C = h.splice(d)[0], N = c.splice(C.index);
                N.unshift(N[0].otherSE), r.push(new n21(N.reverse()));
                continue;
              }
              h.push({
                index: c.length,
  ...
  return be(n21, [{
    ...
    value: function() {
      for (var e = this.events[0].point, r = [e], i = 1, o = this.events.length - 1; i < o; i++) {
        ...
        Ma(s, e, a) !== 0 && (r.push(s), e = s);
      }
      if (r.length === 1)
        return null;
      var u = r[0], l = r[1];
      Ma(u, e, l) === 0 && r.shift(), r.push(r[0]);
...
var Ga = function() {
  function n21(t) {
    Cr(this, n21), this.exteriorRing = t, t.poly = this, this.interiorRings = [];
  }
  return be(n21, [{
    key: "addInterior",
    value: function(e) {
...
var af = function() {
  function n21(t) {
    Cr(this, n21), this.rings = t, this.polys = this._composePolys(t);
  }
  return be(n21, [{
    key: "getGeom",
    value: function() {
      ...
      for (var r = [], i = 0, o = e.length; i < o; i++) {
        ...
        if (!s.poly)
          if (s.isExteriorRing())
            ...
            a.poly || r.push(new Ga(a)), a.poly.addInterior(s);
          }
      }
      return r;
    }
...
var uf = function() {
  function n21(t) {
    ...
    Cr(this, n21), this.queue = t, this.tree = new Ws(e), this.segments = [];
  }
  return be(n21, [{
    key: "process",
    value: function(e) {
      ...
      if (e.isLeft) {
        ...
        if (l) {
          ...
          if (d !== null && (r.isAnEndpoint(d) || (v = d), !l.isAnEndpoint(d)))
            for (var y = this._splitSafely(l, d), I = 0, C = y.length; I < C; I++)
              i.push(y[I]);
        }
        if (c !== null || v !== null) {
          var N = null;
          ...
          if (b !== null) {
            if (!u.isAnEndpoint(b))
              for (var A = this._splitSafely(u, b), Y = 0, G = A.length; Y < G; Y++)
                i.push(A[Y]);
            if (!l.isAnEndpoint(b))
              for (var at = this._splitSafely(l, b), x = 0, k = at.length; x < k; x++)
                i.push(at[x]);
          }
        }
        this.tree.remove(r);
...
var za = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_QUEUE_SIZE || 1e6;
var lf = typeof process < "u" && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS || 1e6;
var cf = function() {
  function n21() {
    Cr(this, n21);
  }
  return be(n21, [{
    ...
    value: function(e, r, i) {
      ...
      eo.reset();
      var x = sf.factory(L.segments), k = new af(x);
      return k.getGeom();
    }
  }]), n21;
}();
...
function ts(n21, t, e) {
  e === void 0 && (e = {});
  var r = { type: "Feature" };
  return (e.id === 0 || e.id) && (r.id = e.id), e.bbox && (r.bbox = e.bbox), r.properties = t || {}, r.geometry = n21, r;
}
function df(n21, t, e) {
  if (e === void 0 && (e = {}), !n21)
...
function Iu(n21, t, e) {
  e === void 0 && (e = {});
  for (var r = 0, i = n21; r < i.length; r++) {
    var o = i[r];
    if (o.length < 4)
...
function Bs(n21, t) {
  ...
  return t.id && (e.id = t.id), t.bbox && (e.bbox = t.bbox), e.features = n21, e;
}
function Nu(n21, t, e) {
  e === void 0 && (e = {});
  var r = {
...
function Va(n21) {
  return !isNaN(n21) && n21 !== null && !Array.isArray(n21);
}
function qo(n21) {
  return n21.type === "Feature" ? n21.geometry : n21;
}
function yf(n21, t, e) {
  e === void 0 && (e = {});
  var r = qo(n21), i = qo(t), o = Eu.union(r.coordinates, i.coordinates);
  return o.length === 0 ? null : o.length === 1 ? Iu(o[0], e.properties) : Nu(o, e.properties);
}
function Su(n21, t, e) {
  if (n21 !== null)
    for (var r, i, o, s, a, u, l, c = 0, f = 0, h, g = n21.type, p = g === "FeatureCollection", v = g === "Feature", d = p ? n21.features.length : 1, y = 0; y < d; y++) {
      l = p ? n21.features[y].geometry : v ? n21.geometry : n21, h = l ? l.type === "GeometryCollection" : false, a = h ? l.geometries.length : 1;
      for (var I = 0; I < a; I++) {
        var C = 0, N = 0;
          ...
          switch (c = e && (L === "Polygon" || L === "MultiPolygon") ? 1 : 0, L) {
            ...
            case "GeometryCollection":
              for (r = 0; r < s.geometries.length; r++)
                if (Su(s.geometries[r], t, e) === false)
                  return false;
              break;
            default:
...
function Ua(n21, t) {
  if (n21.type === "Feature")
    t(n21, 0);
  else if (n21.type === "FeatureCollection")
    for (var e = 0; e < n21.features.length && t(n21.features[e], e) !== false; e++)
      ;
}
function xu(n21, t) {
  var e, r, i, o, s, a, u, l, c, f, h = 0, g = n21.type === "FeatureCollection", p = n21.type === "Feature", v = g ? n21.features.length : 1;
  for (e = 0; e < v; e++) {
    for (a = g ? n21.features[e].geometry : p ? n21.geometry : n21, l = g ? n21.features[e].properties : p ? n21.properties : {}, c = g ? n21.features[e].bbox : p ? n21.bbox : void 0, f = g ? n21.features[e].id : p ? n21.id : void 0, u = a ? a.type === "GeometryCollection" : false, s = u ? a.geometries.length : 1, i = 0; i < s; i++) {
...
function _f(n21, t) {
  t === void 0 && (t = {});
  var e = ks(n21), r = (e[0] + e[2]) / 2, i = (e[1] + e[3]) / 2;
...
Number.isFinite = Number.isFinite || function(n21) {
  return typeof n21 == "number" && isFinite(n21);
};
Number.isInteger = Number.isInteger || function(n21) {
  return typeof n21 == "number" && isFinite(n21) && Math.floor(n21) === n21;
};
Number.parseFloat = Number.parseFloat || parseFloat;
Number.isNaN = Number.isNaN || function(n21) {
  return n21 !== n21;
};
Math.trunc = Math.trunc || function(n21) {
  return n21 < 0 ? Math.ceil(n21) : Math.floor(n21);
};
var Kn = function() {
};
...
var gt = function(n21) {
  function t(e) {
    n21.call(this, e), this.name = "IllegalArgumentException", this.message = e, this.stack = new n21().stack;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t;
}(Error);
var U = function() {
};
var Lu = { MAX_VALUE: { configurable: true } };
U.isNaN = function(t) {
...
var li = { DimensionalComparator: { configurable: true }, serialVersionUID: { configurable: true }, NULL_ORDINATE: { configurable: true }, X: { configurable: true }, Y: { configurable: true }, Z: { configurable: true } };
...
m.prototype.equals = function(t) {
  return t instanceof m ? this.equals2D(t) : false;
};
...
var mo = { INTERIOR: { configurable: true }, BOUNDARY: { configurable: true }, EXTERIOR: { configurable: true }, NONE: { configurable: true } };
...
Object.defineProperties(_, mo);
var V = function(n21, t) {
  return n21.interfaces_ && n21.interfaces_().indexOf(t) > -1;
};
var we = function() {
};
var bu = { LOG_10: { configurable: true } };
...
bu.LOG_10.get = function() {
  return Math.log(10);
};
Object.defineProperties(we, bu);
var Ir = function(t) {
  this.str = t;
};
Ir.prototype.append = function(t) {
  this.str += t;
};
Ir.prototype.setCharAt = function(t, e) {
...
fr.prototype.intValue = function() {
  return this.value;
};
...
var E = function n2() {
  if (this._hi = 0, this._lo = 0, arguments.length === 0)
    ...
    if (typeof arguments[0] == "number") {
      var t = arguments[0];
      this.init(t);
    } else if (arguments[0] instanceof n2) {
      var e = arguments[0];
      this.init(e);
    } else if (typeof arguments[0] == "string") {
      var r = arguments[0];
      n2.call(this, n2.parse(r));
    }
  } else if (arguments.length === 2) {
...
var tr = { PI: { configurable: true }, TWO_PI: { configurable: true }, PI_2: { configurable: true }, E: { configurable: true }, NaN: { configurable: true }, EPS: { configurable: true }, SPLIT: { configurable: true }, MAX_PRINT_DIGITS: { configurable: true }, TEN: { configurable: true }, ONE: { configurable: true }, SCI_NOT_EXPONENT_CHAR: { configurable: true }, SCI_NOT_ZERO: { configurable: true } };
...
E.prototype.extractSignificantDigits = function(t, e) {
  ...
  for (var s = i + 1, a = new Ir(), u = E.MAX_PRINT_DIGITS - 1, l = 0; l <= u; l++) {
    t && l === s && a.append(".");
    var c = Math.trunc(r._hi);
    if (c < 0)
      break;
    var f = false, h = 0;
    c > 9 ? (f = true, h = "9") : h = "0" + c, a.append(h), r = r.subtract(E.valueOf(c)).multiply(E.TEN), f && r.selfAdd(E.TEN);
    var g = true, p = E.magnitude(r._hi);
    if (p < 0 && Math.abs(p) >= u - l && (g = false), !g)
      break;
  }
...
E.prototype.selfAdd = function() {
  if (arguments.length === 1) {
    ...
    var l = arguments[0], c = arguments[1], f = null, h = null, g = null, p = null, v = null, d = null, y = null, I = null;
    v = this._hi + l, g = this._lo + c, y = v - this._hi, I = g - this._lo, d = v - y, p = g - I, d = l - y + (this._hi - d), p = c - I + (this._lo - p), y = d + g, f = v + y, h = y + (v - f), y = p + h;
    var C = f + y, N = y + (f - C);
...
E.prototype.toStandardNotation = function() {
  ...
  if (t !== null)
    return t;
  var e = new Array(1).fill(null), r = this.extractSignificantDigits(true, e), i = e[0] + 1, o = r;
  if (r.charAt(0) === ".")
    o = "0" + r;
  else if (i < 0)
...
E.prototype.toSciNotation = function() {
  ...
  if (t !== null)
    return t;
  var e = new Array(1).fill(null), r = this.extractSignificantDigits(false, e), i = E.SCI_NOT_EXPONENT_CHAR + e[0];
  if (r.charAt(0) === "0")
  ...
  for (var s = new E(), a = 0, u = 0, l = 0; !(e >= r); ) {
    ...
    if (c === "e" || c === "E") {
      ...
      try {
        ...
        throw y instanceof Error ? new Error("Invalid exponent " + h + " in string " + t) : y;
      } finally {
      }
      break;
    }
...
tr.SPLIT.get = function() {
  return 134217729;
};
tr.MAX_PRINT_DIGITS.get = function() {
  return 32;
};
tr.TEN.get = function() {
  return E.valueOf(10);
...
tr.SCI_NOT_EXPONENT_CHAR.get = function() {
  return "E";
};
tr.SCI_NOT_ZERO.get = function() {
  return "0.0E0";
};
Object.defineProperties(E, tr);
var he = function() {
};
var wu = { DP_SAFE_EPSILON: { configurable: true } };
...
wu.DP_SAFE_EPSILON.get = function() {
  return 1e-15;
};
Object.defineProperties(he, wu);
var K = function() {
};
var yo = { X: { configurable: true }, Y: { configurable: true }, Z: { configurable: true }, M: { configurable: true } };
yo.X.get = function() {
  return 0;
};
yo.Y.get = function() {
...
var Vi = function(n21) {
  function t() {
    n21.call(this, "Projective point not representable on the Cartesian plane.");
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.interfaces_ = function() {
    return [];
...
var Ye = function n3() {
  if (this.x = null, this.y = null, this.w = null, arguments.length === 0)
    ...
    } else if (arguments[0] instanceof n3 && arguments[1] instanceof n3) {
      var i = arguments[0], o = arguments[1];
    ...
    var f = arguments[0], h = arguments[1], g = arguments[2], p = arguments[3], v = f.y - h.y, d = h.x - f.x, y = f.x * h.y - h.x * f.y, I = g.y - p.y, C = p.x - g.x, N = g.x * p.y - p.x * g.y;
    this.x = d * N - C * y, this.y = I * y - v * N, this.w = v * C - I * d;
  }
};
...
Ye.prototype.getCoordinate = function() {
  var t = new m();
...
Ye.intersection = function(t, e, r, i) {
...
var F = function n4() {
  if (this._minx = null, this._maxx = null, this._miny = null, this._maxy = null, arguments.length === 0)
    ...
    } else if (arguments[0] instanceof n4) {
      var e = arguments[0];
      this.init(e);
    }
  } else if (arguments.length === 2) {
...
var Ru = { serialVersionUID: { configurable: true } };
...
F.prototype.covers = function() {
  if (arguments.length === 1) {
    if (arguments[0] instanceof m) {
      ...
      var e = arguments[0];
      return this.isNull() || e.isNull() ? false : e.getMinX() >= this._minx && e.getMaxX() <= this._maxx && e.getMinY() >= this._miny && e.getMaxY() <= this._maxy;
    }
  } else if (arguments.length === 2) {
    var r = arguments[0], i = arguments[1];
    return this.isNull() ? false : r >= this._minx && r <= this._maxx && i >= this._miny && i <= this._maxy;
  }
};
F.prototype.intersects = function() {
  if (arguments.length === 1) {
    if (arguments[0] instanceof F) {
      var t = arguments[0];
      return this.isNull() || t.isNull() ? false : !(t._minx > this._maxx || t._maxx < this._minx || t._miny > this._maxy || t._maxy < this._miny);
    ...
    var r = arguments[0], i = arguments[1];
    return this.isNull() ? false : !(r > this._maxx || r < this._minx || i > this._maxy || i < this._miny);
  }
};
...
Ru.serialVersionUID.get = function() {
  return 5873921885273102e3;
};
Object.defineProperties(F, Ru);
var ir = {
  typeStr: /^\s*(\w+)\s*\(\s*(.*)\s*\)\s*$/,
...
rs.prototype.read = function(t) {
  var e, r, i;
  t = t.replace(/[\n\r]/g, " ");
  var o = ir.typeStr.exec(t);
  if (t.search("EMPTY") !== -1 && (o = ir.emptyTypeStr.exec(t), o[2] = void 0), o && (r = o[1].toLowerCase(), i = o[2], yi[r] && (e = yi[r].apply(this, [i]))), e === void 0)
...
rs.prototype.extractGeometry = function(t) {
  ...
  return t.isEmpty() ? i = r + " EMPTY" : i = r + "(" + Xr[e].apply(this, [t]) + ")", i;
};
var Xr = {
   ...
   */
  point: function(t) {
    return Xr.coordinate.call(this, t._coordinates._coordinates[0]);
  },
  /**
  ...
  multipoint: function(t) {
    for (var e = this, r = [], i = 0, o = t._geometries.length; i < o; ++i)
      r.push("(" + Xr.point.apply(e, [t._geometries[i]]) + ")");
    return r.join(",");
  },
  /**
  ...
  linestring: function(t) {
    for (var e = this, r = [], i = 0, o = t._points._coordinates.length; i < o; ++i)
      r.push(Xr.coordinate.apply(e, [t._points._coordinates[i]]));
    return r.join(",");
  },
  ...
  multilinestring: function(t) {
    for (var e = this, r = [], i = 0, o = t._geometries.length; i < o; ++i)
      r.push("(" + Xr.linestring.apply(e, [t._geometries[i]]) + ")");
    return r.join(",");
  },
  /**
  ...
  polygon: function(t) {
    var e = this, r = [];
    r.push("(" + Xr.linestring.apply(this, [t._shell]) + ")");
    for (var i = 0, o = t._holes.length; i < o; ++i)
      r.push("(" + Xr.linestring.apply(e, [t._holes[i]]) + ")");
    return r.join(",");
  },
  /**
  ...
  multipolygon: function(t) {
    for (var e = this, r = [], i = 0, o = t._geometries.length; i < o; ++i)
      r.push("(" + Xr.polygon.apply(e, [t._geometries[i]]) + ")");
    return r.join(",");
  },
  /**
...
var yi = {
  ...
  multipoint: function(t) {
    ...
    for (var r, i = t.trim().split(","), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(yi.point.apply(e, [r]));
  ...
  linestring: function(t) {
    ...
    for (var e = t.trim().split(","), r = [], i, o = 0, s = e.length; o < s; ++o)
      i = e[o].trim().split(ir.spaces), r.push(new m(Number.parseFloat(i[0]), Number.parseFloat(i[1])));
  ...
  multilinestring: function(t) {
    ...
    for (var r, i = t.trim().split(ir.parenComma), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(yi.linestring.apply(e, [r]));
  ...
  polygon: function(t) {
    ...
    for (var r, i, o, s = t.trim().split(ir.parenComma), a, u = [], l = 0, c = s.length; l < c; ++l)
      r = s[l].replace(ir.trimParens, "$1"), i = yi.linestring.apply(e, [r]), o = e.geometryFactory.createLinearRing(i._points), l === 0 ? a = o : u.push(o);
  ...
  multipolygon: function(t) {
    ...
    for (var r, i = t.trim().split(ir.doubleParenComma), o = [], s = 0, a = i.length; s < a; ++s)
      r = i[s].replace(ir.trimParens, "$1"), o.push(yi.polygon.apply(e, [r]));
...
var Zr = function(n21) {
  function t(e) {
    n21.call(this, e), this.name = "RuntimeException", this.message = e, this.stack = new n21().stack;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t;
}(Error);
var Xo = function(n21) {
  function t() {
    if (n21.call(this), arguments.length === 0)
      n21.call(this);
    else if (arguments.length === 1) {
      var e = arguments[0];
      n21.call(this, e);
...
var ci = { DONT_INTERSECT: { configurable: true }, DO_INTERSECT: { configurable: true }, COLLINEAR: { configurable: true }, NO_INTERSECTION: { configurable: true }, POINT_INTERSECTION: { configurable: true }, COLLINEAR_INTERSECTION: { configurable: true } };
...
pt.prototype.toString = function() {
  return He.toLineString(this._inputLines[0][0], this._inputLines[0][1]) + " - " + He.toLineString(this._inputLines[1][0], this._inputLines[1][1]) + this.getTopologySummary();
};
...
var Yn = function(n21) {
  function t() {
    n21.apply(this, arguments);
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.isInSegmentEnvelopes = function(r) {
    ...
    if (arguments.length === 3) {
      ...
      if (this._isProper = false, F.intersects(i, o, r) && M.orientationIndex(i, o, r) === 0 && M.orientationIndex(o, i, r) === 0)
        return this._isProper = true, (r.equals(i) || r.equals(o)) && (this._isProper = false), this._result = n21.POINT_INTERSECTION, null;
      this._result = n21.NO_INTERSECTION;
    } else
      return n21.prototype.computeIntersection.apply(this, arguments);
    ...
    return a && u ? (this._intPt[0] = o, this._intPt[1] = s, n21.COLLINEAR_INTERSECTION) : l && c ? (this._intPt[0] = r, this._intPt[1] = i, n21.COLLINEAR_INTERSECTION) : a && l ? (this._intPt[0] = o, this._intPt[1] = r, o.equals(r) && !u && !c ? n21.POINT_INTERSECTION : n21.COLLINEAR_INTERSECTION) : a && c ? (this._intPt[0] = o, this._intPt[1] = i, o.equals(i) && !u && !l ? n21.POINT_INTERSECTION : n21.COLLINEAR_INTERSECTION) : u && l ? (this._intPt[0] = s, this._intPt[1] = r, s.equals(r) && !a && !c ? n21.POINT_INTERSECTION : n21.COLLINEAR_INTERSECTION) : u && c ? (this._intPt[0] = s, this._intPt[1] = i, s.equals(i) && !a && !l ? n21.POINT_INTERSECTION : n21.COLLINEAR_INTERSECTION) : n21.NO_INTERSECTION;
  }, t.prototype.normalizeToEnvCentre = function(r, i, o, s, a) {
    var u = r.x < i.x ? r.x : i.x, l = r.y < i.y ? r.y : i.y, c = r.x > i.x ? r.x : i.x, f = r.y > i.y ? r.y : i.y, h = o.x < s.x ? o.x : s.x, g = o.y < s.y ? o.y : s.y, p = o.x > s.x ? o.x : s.x, v = o.y > s.y ? o.y : s.y, d = u > h ? u : h, y = c < p ? c : p, I = l > g ? l : g, C = f < v ? f : v, N = (d + y) / 2, L = (I + C) / 2;
    a.x = N, a.y = L, r.x -= a.x, r.y -= a.y, i.x -= a.x, i.y -= a.y, o.x -= a.x, o.y -= a.y, s.x -= a.x, s.y -= a.y;
  }, t.prototype.computeIntersect = function(r, i, o, s) {
    if (this._isProper = false, !F.intersects(r, i, o, s))
      return n21.NO_INTERSECTION;
    ...
    return f ? this.computeCollinearIntersection(r, i, o, s) : (a === 0 || u === 0 || l === 0 || c === 0 ? (this._isProper = false, r.equals2D(o) || r.equals2D(s) ? this._intPt[0] = r : i.equals2D(o) || i.equals2D(s) ? this._intPt[0] = i : a === 0 ? this._intPt[0] = new m(o) : u === 0 ? this._intPt[0] = new m(s) : l === 0 ? this._intPt[0] = new m(r) : c === 0 && (this._intPt[0] = new m(i))) : (this._isProper = true, this._intPt[0] = this.intersection(r, i, o, s)), n21.POINT_INTERSECTION);
...
lr.prototype.countSegment = function(t, e) {
  ...
  if (t.y === this._p.y && e.y === this._p.y) {
    var r = t.x, i = e.x;
    return r > i && (r = e.x, i = t.x), this._p.x >= r && this._p.x <= i && (this._isPointOnSegment = true), null;
  }
...
lr.locatePointInRing = function() {
  if (arguments[0] instanceof m && V(arguments[1], K)) {
    for (var t = arguments[0], e = arguments[1], r = new lr(t), i = new m(), o = new m(), s = 1; s < e.size(); s++)
    ...
    for (var a = arguments[0], u = arguments[1], l = new lr(a), c = 1; c < u.length; c++) {
      var f = u[c], h = u[c - 1];
...
var fi = { CLOCKWISE: { configurable: true }, RIGHT: { configurable: true }, COUNTERCLOCKWISE: { configurable: true }, LEFT: { configurable: true }, COLLINEAR: { configurable: true }, STRAIGHT: { configurable: true } };
M.prototype.interfaces_ = function() {
  return [];
};
M.prototype.getClass = function() {
...
M.isCCW = function(t) {
  ...
  if (l.equals2D(r) || c.equals2D(r) || l.equals2D(c))
    return false;
  var f = M.computeOrientation(l, r, c), h = false;
  return f === 0 ? h = l.x > c.x : h = f > 0, h;
};
M.locatePointInRing = function(t, e) {
  return lr.locatePointInRing(t, e);
};
...
var Br = { serialVersionUID: { configurable: true }, SORTINDEX_POINT: { configurable: true }, SORTINDEX_MULTIPOINT: { configurable: true }, SORTINDEX_LINESTRING: { configurable: true }, SORTINDEX_LINEARRING: { configurable: true }, SORTINDEX_MULTILINESTRING: { configurable: true }, SORTINDEX_POLYGON: { configurable: true }, SORTINDEX_MULTIPOLYGON: { configurable: true }, SORTINDEX_GEOMETRYCOLLECTION: { configurable: true }, geometryChangedFilter: { configurable: true } };
...
z.prototype.equals = function() {
  if (arguments[0] instanceof z) {
    var t = arguments[0];
    return t === null ? false : this.equalsTopo(t);
...
z.prototype.equalsNorm = function(t) {
  return t === null ? false : this.norm().equalsExact(t.norm());
};
...
Hs.interfaces_ = function() {
  return [Jr];
};
Hs.filter = function(t) {
...
var nn = { Mod2BoundaryNodeRule: { configurable: true }, EndPointBoundaryNodeRule: { configurable: true }, MultiValentEndPointBoundaryNodeRule: { configurable: true }, MonoValentEndPointBoundaryNodeRule: { configurable: true }, MOD2_BOUNDARY_RULE: { configurable: true }, ENDPOINT_BOUNDARY_RULE: { configurable: true }, MULTIVALENT_ENDPOINT_BOUNDARY_RULE: { configurable: true }, MONOVALENT_ENDPOINT_BOUNDARY_RULE: { configurable: true }, OGC_SFS_BOUNDARY_RULE: { configurable: true } };
...
js.prototype = new Error();
js.prototype.name = "IndexOutOfBoundsException";
var Ui = function() {
};
...
var We = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.get = function() {
...
var O = function(n21) {
  function t() {
    n21.call(this), this.array_ = [], arguments[0] instanceof Ot && this.addAll(arguments[0]);
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.ensureCapacity = function() {
  }, t.prototype.interfaces_ = function() {
    return [n21, Ot];
  }, t.prototype.add = function(r) {
    return arguments.length === 1 ? this.array_.push(r) : this.array_.splice(arguments[0], arguments[1]), true;
    ...
    for (var i = this, o = false, s = 0, a = this.array_.length; s < a; s++)
      if (i.array_[s] === r) {
        i.array_.splice(s, 1), o = true;
        break;
      }
    return o;
  }, t;
...
var Ef = function(n21) {
  function t(e) {
    n21.call(this), this.arrayList_ = e, this.position_ = 0;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.next = function() {
...
var _o = function(n21) {
  function t() {
    if (n21.call(this), arguments.length !== 0) {
      if (arguments.length === 1) {
        var r = arguments[0];
        this.ensureCapacity(r.length), this.add(r, true);
      } else if (arguments.length === 2) {
        var i = arguments[0], o = arguments[1];
  ...
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { coordArrayType: { configurable: true } };
  return e.coordArrayType.get = function() {
    ...
    var i = this;
    if (arguments.length === 2) {
      for (var o = arguments[0], s = arguments[1], a = false, u = o.iterator(); u.hasNext(); )
        i.add(u.next(), s), a = true;
      return a;
    } else
      return n21.prototype.addAll.apply(this, arguments);
  }, t.prototype.clone = function() {
    for (var i = this, o = n21.prototype.clone.call(this), s = 0; s < this.size(); s++)
    ...
    if (arguments.length === 1) {
      var o = arguments[0];
      n21.prototype.add.call(this, o);
    } else if (arguments.length === 2) {
      if (arguments[0] instanceof Array && typeof arguments[1] == "boolean") {
        var s = arguments[0], a = arguments[1];
        return this.add(s, a, true), true;
        ...
        n21.prototype.add.call(this, u);
      } else if (arguments[0] instanceof Object && typeof arguments[1] == "boolean") {
        var f = arguments[0], h = arguments[1];
        return this.add(f, h), true;
      }
    } else if (arguments.length === 3) {
      if (typeof arguments[2] == "boolean" && arguments[0] instanceof Array && typeof arguments[1] == "boolean") {
        ...
        n21.prototype.add.call(this, I, C);
      }
    } else if (arguments.length === 4) {
    ...
    this.size() > 0 && this.add(new m(this.get(0)), false);
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
    return t;
...
var ns = { ForwardComparator: { configurable: true }, BidirectionalComparator: { configurable: true }, coordArrayType: { configurable: true } };
...
H.intersection = function(t, e) {
  for (var r = new _o(), i = 0; i < t.length; i++)
    e.intersects(t[i]) && r.add(t[i], true);
...
var Qs = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.contains = function(r) {
    ...
    return this.contains(r) ? false : (this.array_.push(r), true);
  }, t.prototype.addAll = function(r) {
    for (var i = this, o = r.iterator(); o.hasNext(); )
      i.add(o.next());
    return true;
...
var If = function(n21) {
  function t(e) {
    n21.call(this), this.hashSet_ = e, this.position_ = 0;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.next = function() {
...
var Sn = 1;
function qa(n21) {
  return n21 === null ? Hr : n21.color;
}
function lt(n21) {
  return n21 === null ? null : n21.parent;
}
function qr(n21, t) {
  n21 !== null && (n21.color = t);
}
function xs(n21) {
  return n21 === null ? null : n21.left;
}
function Xa(n21) {
  return n21 === null ? null : n21.right;
}
function Jt() {
  this.root_ = null, this.size_ = 0;
}
Jt.prototype = new Cf();
Jt.prototype.get = function(n21) {
  for (var t = this.root_; t !== null; ) {
    var e = n21.compareTo(t.key);
    if (e < 0)
      t = t.left;
    else if (e > 0)
      t = t.right;
...
Jt.prototype.put = function(n21, t) {
  if (this.root_ === null)
    return this.root_ = {
      key: n21,
      value: t,
  ...
  do
    if (r = e, i = n21.compareTo(e.key), i < 0)
      e = e.left;
    else if (i > 0)
      e = e.right;
    else {
...
Jt.prototype.fixAfterInsertion = function(n21) {
  var t = this;
  for (n21.color = Sn; n21 != null && n21 !== this.root_ && n21.parent.color === Sn; )
    if (lt(n21) === xs(lt(lt(n21)))) {
      var e = Xa(lt(lt(n21)));
      qa(e) === Sn ? (qr(lt(n21), Hr), qr(e, Hr), qr(lt(lt(n21)), Sn), n21 = lt(lt(n21))) : (n21 === Xa(lt(n21)) && (n21 = lt(n21), t.rotateLeft(n21)), qr(lt(n21), Hr), qr(lt(lt(n21)), Sn), t.rotateRight(lt(lt(n21))));
    } else {
      var r = xs(lt(lt(n21)));
      qa(r) === Sn ? (qr(lt(n21), Hr), qr(r, Hr), qr(lt(lt(n21)), Sn), n21 = lt(lt(n21))) : (n21 === xs(lt(n21)) && (n21 = lt(n21), t.rotateRight(n21)), qr(lt(n21), Hr), qr(lt(lt(n21)), Sn), t.rotateLeft(lt(lt(n21))));
    }
  this.root_.color = Hr;
};
Jt.prototype.values = function() {
  var n21 = new O(), t = this.getFirstEntry();
  if (t !== null)
    for (n21.add(t.value); (t = Jt.successor(t)) !== null; )
      n21.add(t.value);
  return n21;
};
Jt.prototype.entrySet = function() {
  var n21 = new Qs(), t = this.getFirstEntry();
  if (t !== null)
    for (n21.add(t); (t = Jt.successor(t)) !== null; )
      n21.add(t);
  return n21;
};
Jt.prototype.rotateLeft = function(n21) {
  if (n21 != null) {
    var t = n21.right;
    n21.right = t.left, t.left != null && (t.left.parent = n21), t.parent = n21.parent, n21.parent === null ? this.root_ = t : n21.parent.left === n21 ? n21.parent.left = t : n21.parent.right = t, t.left = n21, n21.parent = t;
  }
};
Jt.prototype.rotateRight = function(n21) {
  if (n21 != null) {
    var t = n21.left;
    n21.left = t.right, t.right != null && (t.right.parent = n21), t.parent = n21.parent, n21.parent === null ? this.root_ = t : n21.parent.right === n21 ? n21.parent.right = t : n21.parent.left = t, t.right = n21, n21.parent = t;
  }
};
...
Jt.successor = function(n21) {
  if (n21 === null)
    return null;
  if (n21.right !== null) {
    for (var t = n21.right; t.left !== null; )
      t = t.left;
    return t;
  } else {
    for (var e = n21.parent, r = n21; e !== null && r === e.right; )
      r = e, e = e.parent;
    return e;
  }
};
...
hr.prototype = new Ou();
hr.prototype.contains = function(n21) {
  for (var t = this, e = 0, r = this.array_.length; e < r; e++) {
    var i = t.array_[e];
    if (i.compareTo(n21) === 0)
      return true;
  }
  return false;
};
hr.prototype.add = function(n21) {
  var t = this;
  if (this.contains(n21))
    return false;
  for (var e = 0, r = this.array_.length; e < r; e++) {
    var i = t.array_[e];
    if (i.compareTo(n21) === 1)
      return t.array_.splice(e, 0, n21), true;
  }
  return this.array_.push(n21), true;
};
hr.prototype.addAll = function(n21) {
  for (var t = this, e = n21.iterator(); e.hasNext(); )
    t.add(e.next());
  return true;
};
hr.prototype.remove = function(n21) {
  throw new Eo();
};
hr.prototype.size = function() {
  return this.array_.length;
};
...
hr.prototype.toArray = function() {
  for (var n21 = this, t = [], e = 0, r = this.array_.length; e < r; e++)
    t.push(n21.array_[e]);
  return t;
};
...
var os = function(n21) {
  this.treeSet_ = n21, this.position_ = 0;
};
...
var er = { P: { configurable: true }, L: { configurable: true }, A: { configurable: true }, FALSE: { configurable: true }, TRUE: { configurable: true }, DONTCARE: { configurable: true }, SYM_FALSE: { configurable: true }, SYM_TRUE: { configurable: true }, SYM_DONTCARE: { configurable: true }, SYM_P: { configurable: true }, SYM_L: { configurable: true }, SYM_A: { configurable: true } };
er.P.get = function() {
  return 0;
};
er.L.get = function() {
...
er.FALSE.get = function() {
  return -1;
};
er.TRUE.get = function() {
  return -2;
};
er.DONTCARE.get = function() {
  return -3;
};
er.SYM_FALSE.get = function() {
  return "F";
};
er.SYM_TRUE.get = function() {
  return "T";
};
er.SYM_DONTCARE.get = function() {
  return "*";
};
er.SYM_P.get = function() {
  return "0";
};
er.SYM_L.get = function() {
  return "1";
};
er.SYM_A.get = function() {
  return "2";
};
...
Object.defineProperties(J, er);
var gr = function() {
};
gr.prototype.filter = function(t) {
};
...
je.prototype.filter = function(t, e) {
};
je.prototype.isDone = function() {
};
je.prototype.isGeometryChanged = function() {
};
...
var ae = function(n21) {
  function t(r, i) {
    if (n21.call(this, i), this._geometries = r || [], n21.hasNullElements(this._geometries))
      throw new gt("geometries must not contain null elements");
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { serialVersionUID: { configurable: true } };
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    return n21.SORTINDEX_GEOMETRYCOLLECTION;
    ...
    if (arguments.length === 2) {
      ...
      return n21.prototype.equalsExact.apply(this, arguments);
    ...
    var i = this;
    if (arguments.length === 1) {
      var o = arguments[0], s = new hr(wn.asList(this._geometries)), a = new hr(wn.asList(o._geometries));
    ...
    var i = this, o = n21.prototype.clone.call(this);
...
var Dn = function(n21) {
  ...
  return t.prototype.getSortIndex = function() {
    ...
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
      return this.isEquivalentClass(i) ? n21.prototype.equalsExact.call(this, i, o) : false;
    } else
      return n21.prototype.equalsExact.apply(this, arguments);
  }, t.prototype.getBoundaryDimension = function() {
...
var Ks = { NEWLINE: { configurable: true }, SIMPLE_ORDINATE_FORMAT: { configurable: true } };
...
Nt.isRing = function(t) {
  var e = t.size();
  return e === 0 ? true : e <= 3 ? false : t.getOrdinate(0, K.X) === t.getOrdinate(e - 1, K.X) && t.getOrdinate(0, K.Y) === t.getOrdinate(e - 1, K.Y);
};
...
var mt = function(n21) {
  function t(r, i) {
    n21.call(this, i), this._points = null, this.init(r);
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { serialVersionUID: { configurable: true } };
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    return n21.SORTINDEX_LINESTRING;
  }, t.prototype.getCoordinates = function() {
    ...
    var i = n21.prototype.clone.call(this);
...
var ye = function(n21) {
  function t(r, i) {
    n21.call(this, i), this._coordinates = r || null, this.init(this._coordinates);
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { serialVersionUID: { configurable: true } };
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    return n21.SORTINDEX_POINT;
  }, t.prototype.getCoordinates = function() {
    return this.isEmpty() ? [] : [this.getCoordinate()];
  }, t.prototype.equalsExact = function() {
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
      return this.isEquivalentClass(i) ? this.isEmpty() && i.isEmpty() ? true : this.isEmpty() !== i.isEmpty() ? false : this.equal(i.getCoordinate(), this.getCoordinate(), o) : false;
    } else
      return n21.prototype.equalsExact.apply(this, arguments);
  }, t.prototype.normalize = function() {
  }, t.prototype.getCoordinate = function() {
...
var At = function(n21) {
  function t(r, i, o) {
    if (n21.call(this, o), this._shell = null, this._holes = null, r === null && (r = this.getFactory().createLinearRing()), i === null && (i = []), n21.hasNullElements(i))
      throw new gt("holes must not contain null elements");
    if (r.isEmpty() && n21.hasNonEmptyElements(i))
  ...
  return t.prototype.computeEnvelopeInternal = function() {
    ...
    if (arguments.length === 1) {
      ...
      for (var p = this.getNumInteriorRing(), v = c.getNumInteriorRing(), d = 0; d < p && d < v; ) {
        var y = i.getInteriorRingN(d), I = c.getInteriorRingN(d), C = y.compareToSameClass(I, l);
        if (C !== 0)
          return C;
        d++;
      }
...
var bi = function(n21) {
  ...
  return t.prototype.getSortIndex = function() {
    ...
    if (arguments.length === 1) {
      ...
      return n21.prototype.getCoordinate.apply(this, arguments);
  }, t.prototype.getBoundaryDimension = function() {
    return J.FALSE;
  }, t.prototype.getDimension = function() {
    return 0;
...
var Pr = function(n21) {
  function t(r, i) {
    r instanceof m && i instanceof W && (r = i.getCoordinateSequenceFactory().create(r)), n21.call(this, r, i), this.validateConstruction();
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { MINIMUM_VALID_SIZE: { configurable: true }, serialVersionUID: { configurable: true } };
  return t.prototype.getSortIndex = function() {
    return z.SORTINDEX_LINEARRING;
  }, t.prototype.getBoundaryDimension = function() {
    return J.FALSE;
  }, t.prototype.isClosed = function() {
    return this.isEmpty() ? true : n21.prototype.isClosed.call(this);
  }, t.prototype.reverse = function() {
    var i = this._points.copy();
    Nt.reverse(i);
    ...
    if (!this.isEmpty() && !n21.prototype.isClosed.call(this))
...
var ke = function(t) {
  this._factory = t || null, this._isUserDataCopied = false;
};
var ss = { NoOpGeometryOperation: { configurable: true }, CoordinateOperation: { configurable: true }, CoordinateSequenceOperation: { configurable: true } };
ke.prototype.setCopyUserData = function(t) {
  this._isUserDataCopied = t;
};
ke.prototype.edit = function(t, e) {
  if (t === null)
    return null;
  var r = this.editInternal(t, e);
  return this._isUserDataCopied && r.setUserData(t.getUserData()), r;
};
ke.prototype.editInternal = function(t, e) {
...
ke.prototype.editGeometryCollection = function(t, e) {
  ...
  return i.getClass() === bi ? this._factory.createMultiPoint(o.toArray([])) : i.getClass() === Dn ? this._factory.createMultiLineString(o.toArray([])) : i.getClass() === Lr ? this._factory.createMultiPolygon(o.toArray([])) : this._factory.createGeometryCollection(o.toArray([]));
};
ke.prototype.editPolygon = function(t, e) {
...
ke.GeometryEditorOperation = function() {
};
...
so.prototype.interfaces_ = function() {
  return [ke.GeometryEditorOperation];
};
...
ao.prototype.edit = function(t, e) {
  ...
  return r === null ? t : t instanceof Pr ? e.createLinearRing(r) : t instanceof mt ? e.createLineString(r) : t instanceof ye ? r.length > 0 ? e.createPoint(r[0]) : e.createPoint() : t;
};
...
uo.prototype.edit = function(t, e) {
  return t instanceof Pr ? e.createLinearRing(this.edit(t.getCoordinateSequence(), t)) : t instanceof mt ? e.createLineString(this.edit(t.getCoordinateSequence(), t)) : t instanceof ye ? e.createPoint(this.edit(t.getCoordinateSequence(), t)) : t;
};
...
var Tu = { serialVersionUID: { configurable: true } };
...
Et.prototype.toString = function() {
  ...
  if (this._coordinates.length > 0) {
    var e = new Ir(17 * this._coordinates.length);
...
var Zs = { serialVersionUID: { configurable: true }, instanceObject: { configurable: true } };
...
Object.defineProperties(Rr, Zs);
var Du = function(n21) {
  function t() {
    n21.call(this), this.map_ = /* @__PURE__ */ new Map();
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.get = function(r) {
...
var tt = function n5() {
  if (this._modelType = null, this._scale = null, arguments.length === 0)
    this._modelType = n5.FLOATING;
  else if (arguments.length === 1) {
    if (arguments[0] instanceof pr) {
      var t = arguments[0];
      this._modelType = t, t === n5.FIXED && this.setScale(1);
    } else if (typeof arguments[0] == "number") {
      var e = arguments[0];
      this._modelType = n5.FIXED, this.setScale(e);
    } else if (arguments[0] instanceof n5) {
      var r = arguments[0];
      this._modelType = r._modelType, this._scale = r._scale;
    }
  }
};
var Js = { serialVersionUID: { configurable: true }, maximumPreciseValue: { configurable: true } };
...
tt.prototype.compareTo = function(t) {
  ...
  return new fr(r).compareTo(new fr(i));
};
...
Object.defineProperties(tt, Js);
var pr = function n6(t) {
  this._name = t || null, n6.nameToTypeMap.put(t, this);
};
var $s = { serialVersionUID: { configurable: true }, nameToTypeMap: { configurable: true } };
pr.prototype.readResolve = function() {
  return pr.nameToTypeMap.get(this._name);
};
...
$s.nameToTypeMap.get = function() {
  return new Du();
};
Object.defineProperties(pr, $s);
tt.Type = pr;
tt.FIXED = new pr("FIXED");
tt.FLOATING = new pr("FLOATING");
tt.FLOATING_SINGLE = new pr("FLOATING SINGLE");
var W = function n7() {
  this._precisionModel = new tt(), this._SRID = 0, this._coordinateSequenceFactory = n7.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? V(arguments[0], Ci) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof tt && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
};
var Mu = { serialVersionUID: { configurable: true } };
...
W.prototype.buildGeometry = function(t) {
  for (var e = null, r = false, i = false, o = t.iterator(); o.hasNext(); ) {
    var s = o.next(), a = s.getClass();
    e === null && (e = a), a !== e && (r = true), s.isGeometryCollectionOrDerived() && (i = true);
  }
  if (e === null)
...
Object.defineProperties(W, Mu);
var Pf = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"];
var as = function(t) {
  this.geometryFactory = t || new W();
};
as.prototype.read = function(t) {
  ...
  return Pf.indexOf(r) !== -1 ? sr[r].apply(this, [e.coordinates]) : r === "GeometryCollection" ? sr[r].apply(this, [e.geometries]) : sr[r].apply(this, [e]);
};
as.prototype.write = function(t) {
  var e = t.getGeometryType();
  if (!Yr[e])
    throw new Error("Geometry is not supported");
  return Yr[e].apply(this, [t]);
};
var sr = {
  /**
   ...
   */
  Feature: function(n21) {
    var t = {};
    for (var e in n21)
      t[e] = n21[e];
    if (n21.geometry) {
      var r = n21.geometry.type;
      if (!sr[r])
        throw new Error("Unknown GeoJSON type: " + n21.type);
      t.geometry = this.read(n21.geometry);
    }
    return n21.bbox && (t.bbox = sr.bbox.apply(this, [n21.bbox])), t;
  },
  /**
   ...
   */
  FeatureCollection: function(n21) {
    var t = this, e = {};
    if (n21.features) {
      e.features = [];
      for (var r = 0; r < n21.features.length; ++r)
        e.features.push(t.read(n21.features[r]));
    }
    return n21.bbox && (e.bbox = this.parse.bbox.apply(this, [n21.bbox])), e;
  },
  /**
   ...
   */
  coordinates: function(n21) {
    for (var t = [], e = 0; e < n21.length; ++e) {
      var r = n21[e];
   ...
   */
  MultiPoint: function(n21) {
    for (var t = this, e = [], r = 0; r < n21.length; ++r)
      e.push(sr.Point.apply(t, [n21[r]]));
   ...
   */
  LineString: function(n21) {
    var t = sr.coordinates.apply(this, [n21]);
   ...
   */
  MultiLineString: function(n21) {
    for (var t = this, e = [], r = 0; r < n21.length; ++r)
      e.push(sr.LineString.apply(t, [n21[r]]));
   ...
   */
  Polygon: function(n21) {
    for (var t = this, e = sr.coordinates.apply(this, [n21[0]]), r = this.geometryFactory.createLinearRing(e), i = [], o = 1; o < n21.length; ++o) {
      var s = n21[o], a = sr.coordinates.apply(t, [s]), u = t.geometryFactory.createLinearRing(a);
      i.push(u);
    }
   ...
   */
  MultiPolygon: function(n21) {
    for (var t = this, e = [], r = 0; r < n21.length; ++r) {
      var i = n21[r];
      e.push(sr.Polygon.apply(t, [i]));
    }
   ...
   */
  GeometryCollection: function(n21) {
    for (var t = this, e = [], r = 0; r < n21.length; ++r) {
      var i = n21[r];
      e.push(t.read(i));
    }
...
var Yr = {
   ...
   */
  Point: function(n21) {
    var t = Yr.coordinate.apply(this, [n21.getCoordinate()]);
    return {
      type: "Point",
      coordinates: t
    };
   ...
   */
  MultiPoint: function(n21) {
    for (var t = this, e = [], r = 0; r < n21._geometries.length; ++r) {
      var i = n21._geometries[r], o = Yr.Point.apply(t, [i]);
   ...
   */
  LineString: function(n21) {
    for (var t = this, e = [], r = n21.getCoordinates(), i = 0; i < r.length; ++i) {
      var o = r[i];
      e.push(Yr.coordinate.apply(t, [o]));
    }
    return {
      type: "LineString",
      coordinates: e
  ...
  MultiLineString: function(n21) {
    for (var t = this, e = [], r = 0; r < n21._geometries.length; ++r) {
      var i = n21._geometries[r], o = Yr.LineString.apply(t, [i]);
      e.push(o.coordinates);
    }
    return {
   ...
   */
  Polygon: function(n21) {
    var t = this, e = [], r = Yr.LineString.apply(this, [n21._shell]);
    e.push(r.coordinates);
    for (var i = 0; i < n21._holes.length; ++i) {
      var o = n21._holes[i], s = Yr.LineString.apply(t, [o]);
  ...
  MultiPolygon: function(n21) {
    for (var t = this, e = [], r = 0; r < n21._geometries.length; ++r) {
      var i = n21._geometries[r], o = Yr.Polygon.apply(t, [i]);
      e.push(o.coordinates);
    }
    return {
      type: "MultiPolygon",
  ...
  GeometryCollection: function(n21) {
    for (var t = this, e = [], r = 0; r < n21._geometries.length; ++r) {
      var i = n21._geometries[r], o = i.getGeometryType();
      e.push(Yr[o].apply(t, [i]));
    }
    return {
...
var ta = function(t) {
  this.geometryFactory = t || new W(), this.precisionModel = this.geometryFactory.getPrecisionModel(), this.parser = new as(this.geometryFactory);
};
ta.prototype.read = function(t) {
  var e = this.parser.read(t);
  return this.precisionModel.getType() === tt.FIXED && this.reducePrecision(e), e;
};
ta.prototype.reducePrecision = function(t) {
  var e = this, r, i;
  if (t.coordinate)
...
var us = { ON: { configurable: true }, LEFT: { configurable: true }, RIGHT: { configurable: true } };
...
Nr.prototype = new We();
Nr.prototype.add = function(n21) {
  return this.array_.push(n21), true;
};
Nr.prototype.get = function(n21) {
  if (n21 < 0 || n21 >= this.size())
    throw new Error();
  return this.array_[n21];
};
Nr.prototype.push = function(n21) {
  return this.array_.push(n21), n21;
};
Nr.prototype.pop = function(n21) {
  if (this.array_.length === 0)
    throw new ls();
  return this.array_.pop();
};
Nr.prototype.peek = function() {
  if (this.array_.length === 0)
    throw new ls();
  return this.array_[this.array_.length - 1];
};
Nr.prototype.empty = function() {
  return this.array_.length === 0;
};
Nr.prototype.isEmpty = function() {
  return this.empty();
};
Nr.prototype.search = function(n21) {
  return this.array_.indexOf(n21);
};
...
dr.prototype.getRightmostSide = function(t, e) {
...
dr.prototype.findRightmostEdgeAtVertex = function() {
  var t = this._minDe.getEdge().getCoordinates();
  X.isTrue(this._minIndex > 0 && this._minIndex < t.length, "rightmost point expected to be interior vertex of edge");
  var e = t[this._minIndex - 1], r = t[this._minIndex + 1], i = M.computeOrientation(this._minCoord, r, e), o = false;
  (e.y < this._minCoord.y && r.y < this._minCoord.y && i === M.COUNTERCLOCKWISE || e.y > this._minCoord.y && r.y > this._minCoord.y && i === M.CLOCKWISE) && (o = true), o && (this._minIndex = this._minIndex - 1);
};
dr.prototype.getRightmostSideOfSegment = function(t, e) {
...
dr.prototype.getEdge = function() {
  return this._orientedDe;
};
dr.prototype.checkForRightmostCoordinate = function(t) {
...
dr.prototype.findRightmostEdgeAtNode = function() {
...
dr.prototype.findEdge = function(t) {
...
var $r = function(n21) {
  function t(e, r) {
    n21.call(this, t.msgWithCoord(e, r)), this.pt = r ? new m(r) : null, this.name = "TopologyException";
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.getCoordinate = function() {
    return this.pt;
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
...
var ue = function() {
  this._finder = null, this._dirEdgeList = new O(), this._nodes = new O(), this._rightMostCoord = null, this._env = null, this._finder = new dr();
};
...
ue.prototype.computeNodeDepth = function(t) {
  ...
  for (var s = t.getEdges().iterator(); s.hasNext(); ) {
    var a = s.next();
    a.setVisited(true), e.copySymDepths(a);
  }
};
...
ue.prototype.findResultEdges = function() {
  for (var t = this._dirEdgeList.iterator(); t.hasNext(); ) {
    var e = t.next();
    e.getDepth(P.RIGHT) >= 1 && e.getDepth(P.LEFT) <= 0 && !e.isInteriorAreaEdge() && e.setInResult(true);
  }
};
ue.prototype.computeDepths = function(t) {
  var e = this, r = new Qs(), i = new cs(), o = t.getNode();
  for (i.addLast(o), r.add(o), t.setVisited(true); !i.isEmpty(); ) {
    var s = i.removeFirst();
...
ue.prototype.add = function(t, e) {
  var r = this;
  t.setVisited(true), this._nodes.add(t);
...
var ct = function n8() {
  ...
  if (this.location = null, arguments.length === 1) {
    ...
    } else if (arguments[0] instanceof n8) {
      var i = arguments[0];
...
var rt = function n9() {
  if (this.elt = new Array(2).fill(null), arguments.length === 1) {
    ...
    } else if (arguments[0] instanceof n9) {
      var e = arguments[0];
...
rt.toLineLabel = function(t) {
  for (var e = new rt(_.NONE), r = 0; r < 2; r++)
    e.setLocation(r, t.getLocation(r));
  return e;
};
var Rt = function() {
  this._startDe = null, this._maxNodeDegree = -1, this._edges = new O(), this._pts = new O(), this._label = new rt(_.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new O(), this._geometryFactory = null;
  var t = arguments[0], e = arguments[1];
...
Rt.prototype.computePoints = function(t) {
  ...
  do {
    ...
    e._edges.add(r);
    var o = r.getLabel();
    X.isTrue(o.isArea()), e.mergeLabel(o), e.addPoints(r.getEdge(), r.isForward(), i), i = false, e.setEdgeRing(r, e), r = e.getNext(r);
...
Rt.prototype.setInResult = function() {
  var t = this._startDe;
  do
    t.getEdge().setInResult(true), t = t.getNext();
...
var Rf = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.setEdgeRing = function(r, i) {
    r.setMinEdgeRing(i);
...
var Of = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.buildMinimalRings = function() {
...
Pe.prototype.setCovered = function(t) {
  this._isCovered = t, this._isCoveredSet = true;
};
...
var fs = function(n21) {
  function t() {
    n21.call(this), this._coord = null, this._edges = null;
    var e = arguments[0], r = arguments[1];
    this._coord = e, this._edges = r, this._label = new rt(0, _.NONE);
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.isIncidentEdgeInResult = function() {
    ...
    if (arguments.length === 2) {
      var r = arguments[0], i = arguments[1];
      this._label === null ? this._label = new rt(r, i) : this._label.setLocation(r, i);
    } else
      return n21.prototype.setLabel.apply(this, arguments);
...
vr.prototype.values = function() {
  return this.nodeMap.values();
};
vr.prototype.getBoundaryNodes = function(t) {
...
var Co = { NE: { configurable: true }, NW: { configurable: true }, SW: { configurable: true }, SE: { configurable: true } };
...
var Gs = function(n21) {
  function t() {
    var e = arguments[0], r = arguments[1];
    if (n21.call(this, e), this._isForward = null, this._isInResult = false, this._isVisited = false, this._sym = null, this._next = null, this._nextMin = null, this._edgeRing = null, this._minEdgeRing = null, this._depth = [0, -999, -999], this._isForward = r, r)
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.getNextMin = function() {
    ...
    for (var r = this, i = true, o = 0; o < 2; o++)
      r._label.isArea(o) && r._label.getLocation(o, P.LEFT) === _.INTERIOR && r._label.getLocation(o, P.RIGHT) === _.INTERIOR || (i = false);
    return i;
  }, t.prototype.setNextMin = function(r) {
    this._nextMin = r;
  }, t.prototype.print = function(r) {
    n21.prototype.print.call(this, r), r.print(" " + this._depth[P.LEFT] + "/" + this._depth[P.RIGHT]), r.print(" (" + this.getDepthDelta() + ")"), this._isInResult && r.print(" inResult");
...
var dt = function() {
  if (this._edges = new O(), this._nodes = null, this._edgeEndList = new O(), arguments.length === 0)
    this._nodes = new vr(new wi());
  else if (arguments.length === 1) {
    var t = arguments[0];
    this._nodes = new vr(t);
  }
};
...
dt.prototype.matchInSameDirection = function(t, e, r, i) {
  return t.equals(r) ? M.computeOrientation(t, e, i) === M.COLLINEAR && st.quadrant(t, e) === st.quadrant(r, i) : false;
};
...
dt.prototype.addEdges = function(t) {
  for (var e = this, r = t.iterator(); r.hasNext(); ) {
    var i = r.next();
    e._edges.add(i);
    var o = new Gs(i, true), s = new Gs(i, false);
...
_e.prototype.findEdgeRingContaining = function(t, e) {
  for (var r = t.getLinearRing(), i = r.getEnvelopeInternal(), o = r.getCoordinateN(0), s = null, a = null, u = e.iterator(); u.hasNext(); ) {
    ...
    var h = false;
    f.contains(i) && M.isPointInRing(o, c.getCoordinates()) && (h = true), h && (s === null || a.contains(f)) && (s = l);
  }
  return s;
};
...
var Fu = { serialVersionUID: { configurable: true } };
...
var Bt = function n10() {
  if (this._root = null, this._built = false, this._itemBoundables = new O(), this._nodeCapacity = null, arguments.length === 0) {
    var t = n10.DEFAULT_NODE_CAPACITY;
...
var hs = { IntersectsOp: { configurable: true }, serialVersionUID: { configurable: true }, DEFAULT_NODE_CAPACITY: { configurable: true } };
Bt.prototype.getNodeCapacity = function() {
  return this._nodeCapacity;
};
Bt.prototype.lastNode = function(t) {
...
Bt.prototype.removeItem = function(t, e) {
  for (var r = null, i = t.getChildBoundables().iterator(); i.hasNext(); ) {
    var o = i.next();
    o instanceof Qe && o.getItem() === e && (r = o);
  }
  return r !== null ? (t.getChildBoundables().remove(r), true) : false;
};
Bt.prototype.itemsTree = function() {
  var t = this;
  if (arguments.length === 0) {
    this.build();
...
Bt.prototype.boundablesAtLevel = function() {
  var t = this;
  if (arguments.length === 1) {
...
Bt.prototype.query = function() {
  ...
  if (arguments.length === 1) {
    ...
    else if (V(arguments[2], We) && arguments[0] instanceof Object && arguments[1] instanceof Mt)
      for (var h = arguments[0], g = arguments[1], p = arguments[2], v = g.getChildBoundables(), d = 0; d < v.size(); d++) {
        var y = v.get(d);
        t.getIntersectsOp().intersects(y.getBounds(), h) && (y instanceof Mt ? t.query(h, y, p) : y instanceof Qe ? p.add(y.getItem()) : X.shouldNeverReachHere());
      }
  }
};
Bt.prototype.build = function() {
  if (this._built)
    return null;
...
Bt.prototype.remove = function() {
  ...
  if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1];
    return this.build(), this.getIntersectsOp().intersects(this._root.getBounds(), e) ? this.remove(e, this._root, r) : false;
  } else if (arguments.length === 3) {
...
Bt.prototype.createParentBoundables = function(t, e) {
  var r = this;
  X.isTrue(!t.isEmpty());
  var i = new O();
  i.add(this.createNode(e));
  var o = new O(t);
  Ke.sort(o, this.getComparator());
...
Bt.compareDoubles = function(t, e) {
...
var Bu = function(n21) {
  function t(r) {
    r = r || t.DEFAULT_NODE_CAPACITY, n21.call(this, r);
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { STRtreeNode: { configurable: true }, serialVersionUID: { configurable: true }, xComparator: { configurable: true }, yComparator: { configurable: true }, intersectsOp: { configurable: true }, DEFAULT_NODE_CAPACITY: { configurable: true } };
  return t.prototype.createParentBoundablesFromVerticalSlices = function(i, o) {
    ...
    return arguments.length === 0 ? n21.prototype.size.call(this) : n21.prototype.size.apply(this, arguments);
  }, t.prototype.insert = function() {
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
      if (i.isNull())
        return null;
      n21.prototype.insert.call(this, i, o);
    } else
      return n21.prototype.insert.apply(this, arguments);
    ...
    if (arguments.length === 1) {
      var i = arguments[0];
      return n21.prototype.query.call(this, i);
    } else if (arguments.length === 2) {
      var o = arguments[0], s = arguments[1];
      n21.prototype.query.call(this, o, s);
    } else if (arguments.length === 3) {
      if (V(arguments[2], gn) && arguments[0] instanceof Object && arguments[1] instanceof Mt) {
        var a = arguments[0], u = arguments[1], l = arguments[2];
        n21.prototype.query.call(this, a, u, l);
      } else if (V(arguments[2], We) && arguments[0] instanceof Object && arguments[1] instanceof Mt) {
        var c = arguments[0], f = arguments[1], h = arguments[2];
        n21.prototype.query.call(this, c, f, h);
      }
    }
  }, t.prototype.getComparator = function() {
    return t.yComparator;
  }, t.prototype.createParentBoundablesFromVerticalSlice = function(i, o) {
    return n21.prototype.createParentBoundables.call(this, i, o);
  }, t.prototype.remove = function() {
    if (arguments.length === 2) {
      var i = arguments[0], o = arguments[1];
      return n21.prototype.remove.call(this, i, o);
    } else
      return n21.prototype.remove.apply(this, arguments);
  }, t.prototype.depth = function() {
    return arguments.length === 0 ? n21.prototype.depth.call(this) : n21.prototype.depth.apply(this, arguments);
  }, t.prototype.createParentBoundables = function(i, o) {
    X.isTrue(!i.isEmpty());
    var s = Math.trunc(Math.ceil(i.size() / this.getNodeCapacity())), a = new O(i);
    Ke.sort(a, t.xComparator);
    ...
    if (arguments.length === 1) {
      ...
      var y = arguments[0], I = arguments[1], C = arguments[2], N = new Qe(y, I), L = new bt(this.getRoot(), N, C);
    ...
    return {
      ...
      compare: function(r, i) {
        return n21.compareDoubles(t.centreX(r.getBounds()), t.centreX(i.getBounds()));
      }
    };
    ...
    return {
      ...
      compare: function(r, i) {
        return n21.compareDoubles(t.centreY(r.getBounds()), t.centreY(i.getBounds()));
      }
    };
  }, e.intersectsOp.get = function() {
    return {
      interfaces_: function() {
        return [n21.IntersectsOp];
      },
...
var Ya = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.computeBounds = function() {
...
le.prototype.findCollapseIndex = function(t, e, r) {
  ...
  return e.isInterior() || i--, i === 1 ? (r[0] = t.segmentIndex + 1, true) : false;
};
...
xt.prototype.toString = function() {
  return He.toLineString(new Et(this._pts));
};
...
var ku = { serialVersionUID: { configurable: true } };
...
B.prototype.lineIntersection = function(t) {
  try {
    var e = Ye.intersection(this.p0, this.p1, t.p0, t.p1);
    return e;
  } catch (r) {
    if (!(r instanceof Vi))
      throw r;
...
cr.getChainStartIndices = function(t) {
  var e = 0, r = new O();
  r.add(new fr(e));
  do {
    var i = cr.findChainEnd(t, e);
    r.add(new fr(i)), e = i;
  } while (e < t.length - 1);
  var o = cr.toIntArray(r);
  return o;
};
cr.findChainEnd = function(t, e) {
...
cr.getChains = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return cr.getChains(t, null);
  } else if (arguments.length === 2) {
    for (var e = arguments[0], r = arguments[1], i = new O(), o = cr.getChainStartIndices(e), s = 0; s < o.length - 1; s++) {
...
var ea = function(n21) {
  function t(r) {
    r ? n21.call(this, r) : n21.call(this), this._monoChains = new O(), this._index = new Bu(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0;
  }
  n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t;
  var e = { SegmentOverlapAction: { configurable: true } };
  return t.prototype.getMonotoneChains = function() {
    ...
    for (var o = this, s = cr.getChains(i.getCoordinates(), i), a = s.iterator(); a.hasNext(); ) {
      var u = a.next();
...
var Wa = function(n21) {
  function t() {
    n21.call(this), this._si = null;
    var e = arguments[0];
    this._si = e;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.overlap = function() {
    if (arguments.length === 4) {
      ...
      return n21.prototype.overlap.apply(this, arguments);
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
    return t;
...
var $ = function n11() {
  if (this._quadrantSegments = n11.DEFAULT_QUADRANT_SEGMENTS, this._endCapStyle = n11.CAP_ROUND, this._joinStyle = n11.JOIN_ROUND, this._mitreLimit = n11.DEFAULT_MITRE_LIMIT, this._isSingleSided = false, this._simplifyFactor = n11.DEFAULT_SIMPLIFY_FACTOR, arguments.length !== 0) {
    if (arguments.length === 1) {
      var t = arguments[0];
...
var on = { CAP_ROUND: { configurable: true }, CAP_FLAT: { configurable: true }, CAP_SQUARE: { configurable: true }, JOIN_ROUND: { configurable: true }, JOIN_MITRE: { configurable: true }, JOIN_BEVEL: { configurable: true }, DEFAULT_QUADRANT_SEGMENTS: { configurable: true }, DEFAULT_MITRE_LIMIT: { configurable: true }, DEFAULT_SIMPLIFY_FACTOR: { configurable: true } };
...
var Io = { INIT: { configurable: true }, DELETE: { configurable: true }, KEEP: { configurable: true }, NUM_PTS_TO_CHECK: { configurable: true } };
yt.prototype.isDeletable = function(t, e, r, i) {
  var o = this._inputLine[t], s = this._inputLine[e], a = this._inputLine[r];
  return !this.isConcave(o, s, a) || !this.isShallow(o, s, a, i) ? false : this.isShallowSampled(o, s, t, r, i);
};
yt.prototype.deleteShallowConcavities = function() {
  for (var t = this, e = 1, r = this.findNextNonDeletedIndex(e), i = this.findNextNonDeletedIndex(r), o = false; i < this._inputLine.length; ) {
    var s = false;
    t.isDeletable(e, r, i, t._distanceTol) && (t._isDeleted[r] = yt.DELETE, s = true, o = true), s ? e = i : e = r, r = t.findNextNonDeletedIndex(e), i = t.findNextNonDeletedIndex(r);
  }
  return o;
};
...
Io.INIT.get = function() {
  return 0;
};
Io.DELETE.get = function() {
  return 1;
};
Io.KEEP.get = function() {
  return 1;
};
Io.NUM_PTS_TO_CHECK.get = function() {
  return 10;
};
Object.defineProperties(yt, Io);
var Re = function() {
  this._ptList = null, this._precisionModel = null, this._minimimVertexDistance = 0, this._ptList = new O();
};
var Gu = { COORDINATE_ARRAY_TYPE: { configurable: true } };
...
Gu.COORDINATE_ARRAY_TYPE.get = function() {
  return new Array(0).fill(null);
};
Object.defineProperties(Re, Gu);
var j = function() {
};
var gi = { PI_TIMES_2: { configurable: true }, PI_OVER_2: { configurable: true }, PI_OVER_4: { configurable: true }, COUNTERCLOCKWISE: { configurable: true }, CLOCKWISE: { configurable: true }, NONE: { configurable: true } };
j.prototype.interfaces_ = function() {
  return [];
};
j.prototype.getClass = function() {
...
var ft = function n12() {
  this._maxCurveSegmentError = 0, this._filletAngleQuantum = null, this._closingSegLengthFactor = 1, this._segList = null, this._distance = 0, this._precisionModel = null, this._bufParams = null, this._li = null, this._s0 = null, this._s1 = null, this._s2 = null, this._seg0 = new B(), this._seg1 = new B(), this._offset0 = new B(), this._offset1 = new B(), this._side = 0, this._hasNarrowConcaveAngle = false;
  var t = arguments[0], e = arguments[1], r = arguments[2];
  this._precisionModel = t, this._bufParams = e, this._li = new Yn(), this._filletAngleQuantum = Math.PI / 2 / e.getQuadrantSegments(), e.getQuadrantSegments() >= 8 && e.getJoinStyle() === $.JOIN_ROUND && (this._closingSegLengthFactor = n12.MAX_CLOSING_SEG_LEN_FACTOR), this.init(r);
};
var No = { OFFSET_SEGMENT_SEPARATION_FACTOR: { configurable: true }, INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: true }, CURVE_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: true }, MAX_CLOSING_SEG_LEN_FACTOR: { configurable: true } };
...
ft.prototype.addMitreJoin = function(t, e, r, i) {
  var o = true, s = null;
  try {
    s = Ye.intersection(e.p0, e.p1, r.p0, r.p1);
    var a = i <= 0 ? 1 : s.distance(t) / Math.abs(i);
    a > this._bufParams.getMitreLimit() && (o = false);
  } catch (u) {
    if (u instanceof Vi)
      s = new m(0, 0), o = false;
    else
...
ft.prototype.addLimitedMitreJoin = function(t, e, r, i) {
  var o = this._seg0.p1, s = j.angle(o, this._seg0.p0), a = j.angleBetweenOriented(this._seg0.p0, o, this._seg1.p1), u = a / 2, l = j.normalize(s + u), c = j.normalize(l + Math.PI), f = i * r, h = f * Math.abs(Math.sin(u)), g = r - h, p = o.x + f * Math.cos(c), v = o.y + f * Math.sin(c), d = new m(p, v), y = new B(o, d), I = y.pointAlongOffset(1, g), C = y.pointAlongOffset(1, -g);
...
ft.prototype.addInsideTurn = function(t, e) {
  ...
  else if (this._hasNarrowConcaveAngle = true, this._offset0.p1.distance(this._offset1.p0) < this._distance * ft.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR)
...
var zu = { DepthSegment: { configurable: true } };
ti.prototype.findStabbedSegments = function() {
  ...
  if (arguments.length === 1) {
    ...
    if (V(arguments[2], We) && arguments[0] instanceof m && arguments[1] instanceof Gs)
    ...
    else if (V(arguments[2], We) && arguments[0] instanceof m && V(arguments[1], We))
      for (var v = arguments[0], d = arguments[1], y = arguments[2], I = d.iterator(); I.hasNext(); ) {
        var C = I.next();
        C.isForward() && t.findStabbedSegments(v, C, y);
      }
  }
};
...
zu.DepthSegment.get = function() {
  return An;
};
Object.defineProperties(ti, zu);
var An = function() {
...
et.perpendicularBisector = function(t, e) {
  var r = e.x - t.x, i = e.y - t.y, o = new Ye(t.x + r / 2, t.y + i / 2, 1), s = new Ye(t.x - i + r / 2, t.y + r + i / 2, 1);
  return new Ye(o, s);
};
...
Ge.prototype.addCurve = function(t, e, r) {
  if (t === null || t.length < 2)
    return null;
  var i = new xt(t, new rt(0, _.BOUNDARY, e, r));
...
Ge.prototype.addPolygonRing = function(t, e, r, i, o) {
  if (e === 0 && t.length < Pr.MINIMUM_VALID_SIZE)
    return null;
  var s = i, a = o;
  t.length >= Pr.MINIMUM_VALID_SIZE && M.isCCW(t) && (s = o, a = i, r = P.opposite(r));
...
Ge.prototype.add = function(t) {
  if (t.isEmpty())
    return null;
  t instanceof At ? this.addPolygon(t) : t instanceof mt ? this.addLineString(t) : t instanceof ye ? this.addPoint(t) : t instanceof bi ? this.addCollection(t) : t instanceof Dn ? this.addCollection(t) : t instanceof Lr ? this.addCollection(t) : t instanceof ae && this.addCollection(t);
};
...
var br = function() {
  ...
  var t = arguments[0];
  this._parent = t, this._atStart = true, this._index = 0, this._max = t.getNumGeometries();
};
br.prototype.next = function() {
  if (this._atStart)
    return this._atStart = false, br.isAtomic(this._parent) && this._index++, this._parent;
  ...
  return t instanceof ae ? (this._subcollectionIterator = new br(t), this._subcollectionIterator.next()) : t;
};
...
Le.isPointInRing = function(t, e) {
  return e.getEnvelopeInternal().intersects(t) ? M.isPointInRing(t, e.getCoordinates()) : false;
};
...
te.prototype.computeLabelling = function(t) {
  ...
  for (var r = [false, false], i = this.iterator(); i.hasNext(); )
    for (var o = i.next(), s = o.getLabel(), a = 0; a < 2; a++)
      s.isLine(a) && s.getLocation(a) === _.BOUNDARY && (r[a] = true);
...
var Df = function(n21) {
  function t() {
    n21.call(this), this._resultAreaEdgeList = null, this._label = null, this._SCANNING_FOR_INCOMING = 1, this._LINKING_TO_OUTGOING = 2;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.linkResultDirectedEdges = function() {
    var r = this;
    ...
    var i = this;
    n21.prototype.computeLabelling.call(this, r), this._label = new rt(_.NONE);
...
var Vu = function(n21) {
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.createNode = function(r) {
    return new fs(r, new Df());
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
    return t;
...
var dn = function n13() {
  ...
  var t = arguments[0];
  this._pts = t, this._orientation = n13.orientation(t);
};
...
Ze.prototype.addAll = function(t) {
  for (var e = this, r = t.iterator(); r.hasNext(); )
    e.add(r.next());
};
Ze.prototype.findEdgeIndex = function(t) {
...
Ze.prototype.getEdges = function() {
  return this._edges;
};
Ze.prototype.get = function(t) {
  return this._edges.get(t);
};
Ze.prototype.findEqualEdge = function(t) {
...
Oe.prototype.processIntersections = function(t, e, r, i) {
  ...
  this._li.computeIntersection(o, s, a, u), this._li.hasIntersection() && (this.numIntersections++, this._li.isInteriorIntersection() && (this.numInteriorIntersections++, this._hasInterior = true), this.isTrivialIntersection(t, e, r, i) || (this._hasIntersection = true, t.addIntersections(this._li, e, 0), r.addIntersections(this._li, i, 1), this._li.isProper() && (this.numProperIntersections++, this._hasProper = true, this._hasProperInterior = true)));
};
...
mr.prototype.getSegmentIndex = function() {
  return this.segmentIndex;
};
mr.prototype.getCoordinate = function() {
  return this.coord;
};
mr.prototype.print = function(t) {
...
mr.prototype.isEndPoint = function(t) {
...
mr.prototype.compare = function(t, e) {
...
Tr.prototype.iterator = function() {
  return this._nodeMap.values().iterator();
};
Tr.prototype.addSplitEdges = function(t) {
  var e = this;
  this.addEndpoints();
  for (var r = this.iterator(), i = r.next(); r.hasNext(); ) {
    var o = r.next(), s = e.createSplitEdge(i, o);
...
Tr.prototype.addEndpoints = function() {
  var t = this.edge.pts.length - 1;
  this.add(this.edge.pts[0], 0, 0), this.add(this.edge.pts[t], t, 0);
};
Tr.prototype.createSplitEdge = function(t, e) {
  ...
  for (var l = t.segmentIndex + 1; l <= e.segmentIndex; l++)
    a[u++] = r.edge.pts[l];
  return s && (a[u] = e.coord), new Wo(a, new rt(this.edge._label));
};
Tr.prototype.add = function(t, e, r) {
  var i = new mr(t, e, r), o = this._nodeMap.get(i);
  return o !== null ? o : (this._nodeMap.put(i, i), i);
};
Tr.prototype.isIntersection = function(t) {
  for (var e = this.iterator(); e.hasNext(); ) {
    var r = e.next();
    if (r.coord.equals(t))
      return true;
...
var Yt = function n14() {
  ...
  for (var e = 0; e < 2; e++)
    for (var r = 0; r < 3; r++)
      t._depth[e][r] = n14.NULL_VALUE;
};
var Uu = { NULL_VALUE: { configurable: true } };
...
Uu.NULL_VALUE.get = function() {
  return -1;
};
Object.defineProperties(Yt, Uu);
var Wo = function(n21) {
  function t() {
    if (n21.call(this), this.pts = null, this._env = null, this.eiList = new Tr(this), this._name = null, this._mce = null, this._isIsolated = true, this._depth = new Yt(), this._depthDelta = 0, arguments.length === 1) {
      var e = arguments[0];
      t.call(this, e, null);
    } else if (arguments.length === 2) {
      var r = arguments[0], i = arguments[1];
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.getDepth = function() {
    return this._depth;
  }, t.prototype.getCollapsedEdge = function() {
    var r = new Array(2).fill(null);
    r[0] = this.pts[0], r[1] = this.pts[1];
    var i = new t(r, rt.toLineLabel(this._label));
    return i;
  }, t.prototype.isIsolated = function() {
    ...
    if (this.pts.length !== o.pts.length)
      return false;
    for (var s = true, a = true, u = this.pts.length, l = 0; l < this.pts.length; l++)
      if (i.pts[l].equals2D(o.pts[l]) || (s = false), i.pts[l].equals2D(o.pts[--u]) || (a = false), !s && !a)
        return false;
    return true;
  }, t.prototype.getCoordinate = function() {
    if (arguments.length === 0)
    ...
    return !this._label.isArea() || this.pts.length !== 3 ? false : !!this.pts[0].equals(this.pts[2]);
  }, t.prototype.isClosed = function() {
    ...
    if (arguments.length === 2) {
      ...
      return n21.prototype.updateIM.apply(this, arguments);
  }, t;
}(Pe);
var se = function(t) {
  this._workingPrecisionModel = null, this._workingNoder = null, this._geomFact = null, this._graph = null, this._edgeList = new Ze(), this._bufParams = t || null;
};
...
se.prototype.insertUniqueEdge = function(t) {
  ...
  if (e !== null) {
    ...
    e.isPointwiseEqual(t) || (i = new rt(t.getLabel()), i.flip()), r.merge(i);
...
se.prototype.buffer = function(t, e) {
  ...
  this.computeNodedEdges(s, r), this._graph = new dt(new Vu()), this._graph.addEdges(this._edgeList.getEdges());
...
se.prototype.computeNodedEdges = function(t, e) {
  ...
  for (var o = i.getNodedSubstrings(), s = o.iterator(); s.hasNext(); ) {
    ...
    if (!(u.length === 2 && u[0].equals2D(u[1]))) {
      var l = a.getData(), c = new Wo(a.getCoordinates(), new rt(l));
...
var qu = { fact: { configurable: true } };
yr.prototype.checkEndPtVertexIntersections = function() {
  var t = this;
  if (arguments.length === 0)
...
yr.prototype.checkInteriorIntersections = function() {
  var t = this;
  if (arguments.length === 0)
    for (var e = this._segStrings.iterator(); e.hasNext(); )
    ...
    if (h === p && g === v)
      return null;
    var d = h.getCoordinates()[g], y = h.getCoordinates()[g + 1], I = p.getCoordinates()[v], C = p.getCoordinates()[v + 1];
    if (this._li.computeIntersection(d, y, I, C), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, d, y) || this.hasInteriorIntersection(this._li, I, C)))
      throw new Zr("found non-noded intersection at " + d + "-" + y + " and " + I + "-" + C);
  }
};
yr.prototype.checkValid = function() {
  this.checkEndPtVertexIntersections(), this.checkInteriorIntersections(), this.checkCollapses();
};
yr.prototype.checkCollapses = function() {
  var t = this;
  if (arguments.length === 0)
    for (var e = this._segStrings.iterator(); e.hasNext(); ) {
      var r = e.next();
...
yr.prototype.hasInteriorIntersection = function(t, e, r) {
...
yr.prototype.checkCollapse = function(t, e, r) {
  if (t.equals(r))
    throw new Zr("found non-noded collapse at " + yr.fact.createLineString([t, e, r]));
};
...
qu.fact.get = function() {
  return new W();
};
Object.defineProperties(yr, qu);
var pe = function() {
...
var Xu = { SAFE_ENV_EXPANSION_FACTOR: { configurable: true } };
...
Xu.SAFE_ENV_EXPANSION_FACTOR.get = function() {
  return 0.75;
};
Object.defineProperties(pe, Xu);
var ho = function() {
...
var Yu = { HotPixelSnapAction: { configurable: true } };
Ti.prototype.snap = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return this.snap(t, null, -1);
  } else if (arguments.length === 3) {
    var e = arguments[0], r = arguments[1], i = arguments[2], o = e.getSafeEnvelope(), s = new Wu(e, r, i);
...
Yu.HotPixelSnapAction.get = function() {
  return Wu;
};
Object.defineProperties(Ti, Yu);
var Wu = function(n21) {
  function t() {
    n21.call(this), this._hotPixel = null, this._parentEdge = null, this._hotPixelVertexIndex = null, this._isNodeAdded = false;
    var e = arguments[0], r = arguments[1], i = arguments[2];
    this._hotPixel = e, this._parentEdge = r, this._hotPixelVertexIndex = i;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.isNodeAdded = function() {
    ...
    if (arguments.length === 2) {
      ...
      return n21.prototype.select.apply(this, arguments);
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
    return t;
...
Dr.prototype.checkCorrectness = function(t) {
  var e = xt.getNodedSubstrings(t), r = new yr(e);
  try {
    r.checkValid();
  } catch (i) {
    if (i instanceof Pu)
...
Dr.prototype.computeNodes = function(t) {
  this._nodedSegStrings = t, this._noder = new ea(), this._pointSnapper = new Ti(this._noder.getIndex()), this.snapRound(t, this._li);
};
Dr.prototype.computeIntersectionSnaps = function(t) {
  for (var e = this, r = t.iterator(); r.hasNext(); ) {
...
var Xi = { CAP_ROUND: { configurable: true }, CAP_BUTT: { configurable: true }, CAP_FLAT: { configurable: true }, CAP_SQUARE: { configurable: true }, MAX_PRECISION_DIGITS: { configurable: true } };
Xt.prototype.bufferFixedPrecision = function(t) {
  var e = new vn(new Dr(new tt(1)), t.getScale()), r = new se(this._bufParams);
...
Xt.bufferOp = function() {
  if (arguments.length === 2) {
    ...
    var v = arguments[0], d = arguments[1], y = arguments[2], I = arguments[3], C = new Xt(v);
...
var ne = function() {
  this._pt = [new m(), new m()], this._distance = U.NaN, this._isNull = true;
};
...
ne.prototype.initialize = function() {
  if (arguments.length === 0)
    ...
    var t = arguments[0], e = arguments[1];
    this._pt[0].setCoordinate(t), this._pt[1].setCoordinate(e), this._distance = t.distance(e), this._isNull = false;
  } else if (arguments.length === 3) {
    var r = arguments[0], i = arguments[1], o = arguments[2];
    this._pt[0].setCoordinate(r), this._pt[1].setCoordinate(i), this._distance = o, this._isNull = false;
  }
};
  ...
  if (arguments[2] instanceof ne && arguments[0] instanceof mt && arguments[1] instanceof m)
    ...
    if (h instanceof mt)
      ...
      for (var v = h, d = 0; d < v.getNumGeometries(); d++) {
        var y = v.getGeometryN(d);
        Sr.computeDistance(y, g, p);
      }
    else
      p.setMinimum(h.getCoordinate(), g);
  } else if (arguments[2] instanceof ne && arguments[0] instanceof B && arguments[1] instanceof m) {
...
var ra = { MaxPointDistanceFilter: { configurable: true }, MaxMidpointDistanceFilter: { configurable: true } };
...
ra.MaxPointDistanceFilter.get = function() {
  return ri;
};
ra.MaxMidpointDistanceFilter.get = function() {
  return mn;
};
Object.defineProperties(kn, ra);
var ri = function(t) {
...
Je.prototype.updateLocationInfo = function(t) {
  t === _.INTERIOR && (this._isIn = true), t === _.BOUNDARY && this._numBoundaries++;
};
Je.prototype.computeLocation = function(t, e) {
  ...
  if (e instanceof ye && this.updateLocationInfo(this.locateInternal(t, e)), e instanceof mt)
    ...
    for (var c = new br(e); c.hasNext(); ) {
      var f = c.next();
      f !== e && r.computeLocation(t, f);
    }
};
Je.prototype.locate = function(t, e) {
  return e.isEmpty() ? _.EXTERIOR : e instanceof mt ? this.locateInternal(t, e) : e instanceof At ? this.locateInternal(t, e) : (this._isIn = false, this._numBoundaries = 0, this.computeLocation(t, e), this._boundaryRule.isInBoundary(this._numBoundaries) ? _.BOUNDARY : this._numBoundaries > 0 || this._isIn ? _.INTERIOR : _.EXTERIOR);
};
Je.prototype.interfaces_ = function() {
  return [];
};
...
var ie = function n15() {
  if (this._component = null, this._segIndex = null, this._pt = null, arguments.length === 2) {
    var t = arguments[0], e = arguments[1];
    n15.call(this, t, n15.INSIDE_AREA, e);
  } else if (arguments.length === 3) {
    var r = arguments[0], i = arguments[1], o = arguments[2];
    this._component = r, this._segIndex = i, this._pt = o;
  }
};
var Hu = { INSIDE_AREA: { configurable: true } };
...
Hu.INSIDE_AREA.get = function() {
  return -1;
};
Object.defineProperties(ie, Hu);
var un = function(t) {
  this._pts = t || null;
};
...
un.getPoints = function() {
  if (arguments.length === 1) {
    var t = arguments[0];
    return t instanceof ye ? Ke.singletonList(t) : un.getPoints(t, new O());
  } else if (arguments.length === 2) {
    var e = arguments[0], r = arguments[1];
...
var Ht = function() {
  if (this._geom = null, this._terminateDistance = 0, this._ptLocator = new Je(), this._minDistanceLocation = null, this._minDistance = U.MAX_VALUE, arguments.length === 2) {
    var t = arguments[0], e = arguments[1];
...
Ht.prototype.computeContainmentDistance = function() {
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[2] instanceof Array && V(arguments[0], We) && V(arguments[1], We)) {
      ...
      var p = arguments[0], v = arguments[1], d = arguments[2], y = p.getCoordinate();
      if (_.EXTERIOR !== this._ptLocator.locate(y, v))
        return this._minDistance = 0, d[0] = p, d[1] = new ie(v, y), null;
    }
  }
};
...
Ht.prototype.computeFacetDistance = function() {
  ...
  if (this.computeMinDistanceLines(e, r, t), this.updateMinDistance(t, false), this._minDistance <= this._terminateDistance || (t[0] = null, t[1] = null, this.computeMinDistanceLinesPoints(e, o, t), this.updateMinDistance(t, false), this._minDistance <= this._terminateDistance) || (t[0] = null, t[1] = null, this.computeMinDistanceLinesPoints(r, i, t), this.updateMinDistance(t, true), this._minDistance <= this._terminateDistance))
    return null;
  t[0] = null, t[1] = null, this.computeMinDistancePoints(i, o, t), this.updateMinDistance(t, false);
};
    ...
    if (arguments[2] instanceof Array && arguments[0] instanceof mt && arguments[1] instanceof ye) {
      ...
      for (var p = f.getCoordinates(), v = h.getCoordinates(), d = 0; d < p.length - 1; d++)
        for (var y = 0; y < v.length - 1; y++) {
          var I = M.distanceLineLine(p[d], p[d + 1], v[y], v[y + 1]);
          if (I < t._minDistance) {
            t._minDistance = I;
            var C = new B(p[d], p[d + 1]), N = new B(v[y], v[y + 1]), L = C.closestPoints(N);
            g[0] = new ie(f, d, L[0]), g[1] = new ie(h, y, L[1]);
          }
          if (t._minDistance <= t._terminateDistance)
            return null;
        }
...
Zt.prototype.toString = function() {
  return He.toLineString(this._pt[0], this._pt[1]);
};
...
ar.computeDistance = function() {
  if (arguments[2] instanceof Zt && arguments[0] instanceof mt && arguments[1] instanceof m)
    ...
    var u = arguments[0], l = arguments[1], c = arguments[2];
    ar.computeDistance(u.getExteriorRing(), l, c);
    for (var f = 0; f < u.getNumInteriorRing(); f++)
      ar.computeDistance(u.getInteriorRingN(f), l, c);
  } else if (arguments[2] instanceof Zt && arguments[0] instanceof z && arguments[1] instanceof m) {
    var h = arguments[0], g = arguments[1], p = arguments[2];
    if (h instanceof mt)
      ar.computeDistance(h, g, p);
    else if (h instanceof At)
      ar.computeDistance(h, g, p);
    else if (h instanceof ae)
      for (var v = h, d = 0; d < v.getNumGeometries(); d++) {
        var y = v.getGeometryN(d);
        ar.computeDistance(y, g, p);
      }
    else
      p.setMinimum(h.getCoordinate(), g);
  } else if (arguments[2] instanceof Zt && arguments[0] instanceof B && arguments[1] instanceof m) {
    var I = arguments[0], C = arguments[1], N = arguments[2], L = I.closestPoint(C);
    N.setMinimum(L, C);
  }
};
...
var na = { MaxPointDistanceFilter: { configurable: true }, MaxDensifiedByFractionDistanceFilter: { configurable: true } };
...
na.MaxDensifiedByFractionDistanceFilter.get = function() {
  return yn;
};
Object.defineProperties(Fe, na);
var ii = function() {
  this._maxPtDist = new Zt(), this._minPtDist = new Zt(), this._euclideanDist = new ar(), this._geom = null;
  var t = arguments[0];
  this._geom = t;
};
ii.prototype.filter = function(t) {
  this._minPtDist.initialize(), ar.computeDistance(this._geom, t, this._minPtDist), this._maxPtDist.setMaximum(this._minPtDist);
};
...
yn.prototype.filter = function(t, e) {
  ...
  for (var i = t.getCoordinate(e - 1), o = t.getCoordinate(e), s = (o.x - i.x) / this._numSubSegs, a = (o.y - i.y) / this._numSubSegs, u = 0; u < this._numSubSegs; u++) {
    ...
    r._minPtDist.initialize(), ar.computeDistance(r._geom, f, r._minPtDist), r._maxPtDist.setMaximum(r._minPtDist);
  }
};
...
var ve = function(t, e, r) {
  this._minValidDistance = null, this._maxValidDistance = null, this._minDistanceFound = null, this._maxDistanceFound = null, this._isValid = true, this._errMsg = null, this._errorLocation = null, this._errorIndicator = null, this._input = t || null, this._bufDistance = e || null, this._result = r || null;
};
var ia = { VERBOSE: { configurable: true }, MAX_DISTANCE_DIFF_FRAC: { configurable: true } };
ve.prototype.checkMaximumDistance = function(t, e, r) {
  ...
  if (i.setDensifyFraction(0.25), this._maxDistanceFound = i.orientedDistance(), this._maxDistanceFound > r) {
    ...
    this._errorLocation = o[1], this._errorIndicator = t.getFactory().createLineString(o), this._errMsg = "Distance between buffer curve and input is too large (" + this._maxDistanceFound + " at " + He.toLineString(o[0], o[1]) + ")";
  }
};
ve.prototype.isValid = function() {
  var t = Math.abs(this._bufDistance), e = ve.MAX_DISTANCE_DIFF_FRAC * t;
  return this._minValidDistance = t - e, this._maxValidDistance = t + e, this._input.isEmpty() || this._result.isEmpty() ? true : (this._bufDistance > 0 ? this.checkPositiveValid() : this.checkNegativeValid(), ve.VERBOSE && Wt.out.println("Min Dist= " + this._minDistanceFound + "  err= " + (1 - this._minDistanceFound / this._bufDistance) + "  Max Dist= " + this._maxDistanceFound + "  err= " + (this._maxDistanceFound / this._bufDistance - 1)), this._isValid);
};
ve.prototype.checkNegativeValid = function() {
  if (!(this._input instanceof At || this._input instanceof Lr || this._input instanceof ae))
    return null;
...
ve.prototype.checkMinimumDistance = function(t, e, r) {
  ...
  if (this._minDistanceFound = i.distance(), this._minDistanceFound < r) {
    ...
    this._errorLocation = i.nearestPoints()[1], this._errorIndicator = t.getFactory().createLineString(o), this._errMsg = "Distance between buffer curve and input is too small (" + this._minDistanceFound + " at " + He.toLineString(o[0], o[1]) + " )";
  }
};
...
ia.VERBOSE.get = function() {
  return false;
};
ia.MAX_DISTANCE_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties(ve, ia);
var jt = function(t, e, r) {
  this._isValid = true, this._errorMsg = null, this._errorLocation = null, this._errorIndicator = null, this._input = t || null, this._distance = e || null, this._result = r || null;
};
var oa = { VERBOSE: { configurable: true }, MAX_ENV_DIFF_FRAC: { configurable: true } };
...
jt.prototype.checkEnvelope = function() {
  ...
  r.expandBy(t), r.contains(e) || (this._isValid = false, this._errorMsg = "Buffer envelope is incorrect", this._errorIndicator = this._input.getFactory().toGeometry(r)), this.report("Envelope");
};
jt.prototype.checkDistance = function() {
  var t = new ve(this._input, this._distance, this._result);
  t.isValid() || (this._isValid = false, this._errorMsg = t.getErrorMessage(), this._errorLocation = t.getErrorLocation(), this._errorIndicator = t.getErrorIndicator()), this.report("Distance");
};
jt.prototype.checkArea = function() {
  var t = this._input.getArea(), e = this._result.getArea();
  this._distance > 0 && t > e && (this._isValid = false, this._errorMsg = "Area of positive buffer is smaller than input", this._errorIndicator = this._result), this._distance < 0 && t < e && (this._isValid = false, this._errorMsg = "Area of negative buffer is larger than input", this._errorIndicator = this._result), this.report("Area");
};
jt.prototype.checkPolygonal = function() {
  this._result instanceof At || this._result instanceof Lr || (this._isValid = false), this._errorMsg = "Result is not polygonal", this._errorIndicator = this._result, this.report("Polygonal");
};
...
jt.prototype.checkExpectedEmpty = function() {
  if (this._input.getDimension() >= 2 || this._distance > 0)
    return null;
  this._result.isEmpty() || (this._isValid = false, this._errorMsg = "Result is non-empty", this._errorIndicator = this._result), this.report("ExpectedEmpty");
};
...
oa.MAX_ENV_DIFF_FRAC.get = function() {
  return 0.012;
};
Object.defineProperties(jt, oa);
var _r = function() {
...
_r.prototype.size = function() {
  return this._pts.length;
};
_r.prototype.getCoordinate = function(t) {
  return this._pts[t];
};
_r.prototype.isClosed = function() {
  return this._pts[0].equals(this._pts[this._pts.length - 1]);
};
_r.prototype.getSegmentOctant = function(t) {
  return t === this._pts.length - 1 ? -1 : $n.octant(this.getCoordinate(t), this.getCoordinate(t + 1));
};
_r.prototype.setData = function(t) {
  this._data = t;
};
...
var kt = function() {
  this._findAllIntersections = false, this._isCheckEndSegmentsOnly = false, this._li = null, this._interiorIntersection = null, this._intSegments = null, this._intersections = new O(), this._intersectionCount = 0, this._keepIntersections = true;
  var t = arguments[0];
  this._li = t, this._interiorIntersection = null;
};
kt.prototype.getInteriorIntersection = function() {
  return this._interiorIntersection;
};
kt.prototype.setCheckEndSegmentsOnly = function(t) {
  this._isCheckEndSegmentsOnly = t;
};
kt.prototype.getIntersectionSegments = function() {
  return this._intSegments;
};
kt.prototype.count = function() {
  return this._intersectionCount;
};
kt.prototype.getIntersections = function() {
  return this._intersections;
};
kt.prototype.setFindAllIntersections = function(t) {
  this._findAllIntersections = t;
};
kt.prototype.setKeepIntersections = function(t) {
  this._keepIntersections = t;
};
kt.prototype.processIntersections = function(t, e, r, i) {
...
kt.prototype.isEndSegment = function(t, e) {
...
kt.prototype.isDone = function() {
  return this._findAllIntersections ? false : this._interiorIntersection !== null;
};
...
kt.createAllIntersectionsFinder = function(t) {
  var e = new kt(t);
  return e.setFindAllIntersections(true), e;
};
kt.createAnyIntersectionFinder = function(t) {
  return new kt(t);
};
kt.createIntersectionCounter = function(t) {
  var e = new kt(t);
  return e.setFindAllIntersections(true), e.setKeepIntersections(false), e;
};
var $e = function() {
  this._li = new Yn(), this._segStrings = null, this._findAllIntersections = false, this._segInt = null, this._isValid = true;
  var t = arguments[0];
  this._segStrings = t;
};
...
$e.prototype.getIntersections = function() {
  return this._segInt.getIntersections();
};
$e.prototype.isValid = function() {
  return this.execute(), this._isValid;
};
$e.prototype.setFindAllIntersections = function(t) {
  this._findAllIntersections = t;
};
$e.prototype.checkInteriorIntersections = function() {
  this._isValid = true, this._segInt = new kt(this._li), this._segInt.setFindAllIntersections(this._findAllIntersections);
  var t = new ea();
...
$e.prototype.getErrorMessage = function() {
  ...
  return "found non-noded intersection between " + He.toLineString(t[0], t[1]) + " and " + He.toLineString(t[2], t[3]);
};
$e.prototype.interfaces_ = function() {
  return [];
};
...
$e.computeIntersections = function(t) {
  var e = new $e(t);
  return e.setFindAllIntersections(true), e.isValid(), e.getIntersections();
};
var Gn = function n16() {
  this._nv = null;
  var t = arguments[0];
  this._nv = new $e(n16.toSegmentStrings(t));
};
...
Gn.toSegmentStrings = function(t) {
  for (var e = new O(), r = t.iterator(); r.hasNext(); ) {
    var i = r.next();
    e.add(new _r(i.getCoordinates(), i));
  }
  return e;
};
...
Er.prototype.collectLines = function(t) {
...
Er.prototype.labelIsolatedLine = function(t, e) {
  var r = this._ptLocator.locate(t.getCoordinate(), this._op.getArgGeometry(e));
  t.getLabel().setLocation(e, r);
};
Er.prototype.build = function(t) {
  return this.findCoveredLineEdges(), this.collectLines(t), this.buildLines(t), this._resultLineList;
};
Er.prototype.collectLineEdge = function(t, e, r) {
  var i = t.getLabel(), o = t.getEdge();
  t.isLineEdge() && !t.isVisited() && q.isResultOfOp(i, e) && !o.isCovered() && (r.add(o), t.setVisitedEdge(true));
};
Er.prototype.findCoveredLineEdges = function() {
...
Er.prototype.labelIsolatedLines = function(t) {
  for (var e = this, r = t.iterator(); r.hasNext(); ) {
    var i = r.next(), o = i.getLabel();
    i.isIsolated() && (o.isNull(0) ? e.labelIsolatedLine(i, 0) : e.labelIsolatedLine(i, 1));
  }
};
Er.prototype.buildLines = function(t) {
  for (var e = this, r = this._lineEdgesList.iterator(); r.hasNext(); ) {
    ...
    e._resultLineList.add(o), i.setInResult(true);
  }
};
Er.prototype.collectBoundaryTouchEdge = function(t, e, r) {
  var i = t.getLabel();
  if (t.isLineEdge() || t.isVisited() || t.isInteriorAreaEdge() || t.getEdge().isInResult())
    return null;
  X.isTrue(!(t.isInResult() || t.getSym().isInResult()) || !t.getEdge().isInResult()), q.isResultOfOp(i, e) && e === q.INTERSECTION && (r.add(t.getEdge()), t.setVisitedEdge(true));
};
...
de.prototype.transformPolygon = function(t, e) {
  var r = this, i = true, o = this.transformLinearRing(t.getExteriorRing(), t);
  (o === null || !(o instanceof Pr) || o.isEmpty()) && (i = false);
  for (var s = new O(), a = 0; a < t.getNumInteriorRing(); a++) {
    var u = r.transformLinearRing(t.getInteriorRingN(a), t);
    u === null || u.isEmpty() || (u instanceof Pr || (i = false), s.add(u));
  }
  if (i)
    return this._factory.createPolygon(o, s.toArray([]));
  var l = new O();
...
var Mr = function n17() {
  if (this._snapTolerance = 0, this._srcPts = null, this._seg = new B(), this._allowSnappingToSourceVertices = false, this._isClosed = false, arguments[0] instanceof mt && typeof arguments[1] == "number") {
    var t = arguments[0], e = arguments[1];
    n17.call(this, t.getCoordinates(), e);
  } else if (arguments[0] instanceof Array && typeof arguments[1] == "number") {
    var r = arguments[0], i = arguments[1];
    this._srcPts = r, this._isClosed = n17.isClosed(r), this._snapTolerance = i;
  }
};
...
Mr.isClosed = function(t) {
  return t.length <= 1 ? false : t[0].equals2D(t[t.length - 1]);
};
var Ct = function(t) {
  this._srcGeom = t || null;
};
var ju = { SNAP_PRECISION_FACTOR: { configurable: true } };
Ct.prototype.snapTo = function(t, e) {
  var r = this.extractTargetCoordinates(t), i = new Qu(e, r);
  return i.transform(this._srcGeom);
};
Ct.prototype.snapToSelf = function(t, e) {
  var r = this.extractTargetCoordinates(this._srcGeom), i = new Qu(t, r, true), o = i.transform(this._srcGeom), s = o;
...
Ct.prototype.extractTargetCoordinates = function(t) {
  for (var e = new hr(), r = t.getCoordinates(), i = 0; i < r.length; i++)
    e.add(r[i]);
...
ju.SNAP_PRECISION_FACTOR.get = function() {
  return 1e-9;
};
Object.defineProperties(Ct, ju);
var Qu = function(n21) {
  function t(e, r, i) {
    n21.call(this), this._snapTolerance = e || null, this._snapPts = r || null, this._isSelfSnap = i !== void 0 ? i : false;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.snapLine = function(r, i) {
...
re.prototype.add = function(t) {
  ...
  if (this._isFirst)
    return this._commonBits = e, this._commonSignExp = re.signExpBits(this._commonBits), this._isFirst = false, null;
...
var sa = { CommonCoordinateFilter: { configurable: true }, Translater: { configurable: true } };
...
sa.CommonCoordinateFilter.get = function() {
  return ai;
};
sa.Translater.get = function() {
  return En;
};
Object.defineProperties(_n, sa);
var ai = function() {
...
var Ce = function n18() {
  if (this._label = null, this._xValue = null, this._eventType = null, this._insertEvent = null, this._deleteEventIndex = null, this._obj = null, arguments.length === 2) {
    var t = arguments[0], e = arguments[1];
    this._eventType = n18.DELETE, this._xValue = t, this._insertEvent = e;
  } else if (arguments.length === 3) {
    var r = arguments[0], i = arguments[1], o = arguments[2];
    this._eventType = n18.INSERT, this._label = r, this._xValue = i, this._obj = o;
  }
};
var aa = { INSERT: { configurable: true }, DELETE: { configurable: true } };
...
Ce.prototype.isSameLabel = function(t) {
  return this._label === null ? false : this._label === t._label;
};
...
aa.INSERT.get = function() {
  return 1;
};
aa.DELETE.get = function() {
  return 2;
};
Object.defineProperties(Ce, aa);
var Ho = function() {
};
Ho.prototype.interfaces_ = function() {
  return [];
...
Qt.prototype.isBoundaryPoint = function(t, e) {
  return e === null ? false : !!(this.isBoundaryPointInternal(t, e[0]) || this.isBoundaryPointInternal(t, e[1]));
};
...
Qt.prototype.addIntersections = function(t, e, r, i) {
  ...
  this.numTests++;
  var o = t.getCoordinates()[e], s = t.getCoordinates()[e + 1], a = r.getCoordinates()[i], u = r.getCoordinates()[i + 1];
  this._li.computeIntersection(o, s, a, u), this._li.hasIntersection() && (this._recordIsolated && (t.setIsolated(false), r.setIsolated(false)), this._numIntersections++, this.isTrivialIntersection(t, e, r, i) || (this._hasIntersection = true, (this._includeProper || !this._li.isProper()) && (t.addIntersections(this._li, e, 0), r.addIntersections(this._li, i, 1)), this._li.isProper() && (this._properIntersectionPoint = this._li.getIntersection(0).copy(), this._hasProper = true, this._isDoneWhenProperInt && (this._isDone = true), this.isBoundaryPoint(this._li, this._bdyNodes) || (this._hasProperInterior = true))));
};
Qt.prototype.interfaces_ = function() {
  return [];
};
...
var Mf = function(n21) {
  function t() {
    n21.call(this), this.events = new O(), this.nOverlaps = null;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.prepareEvents = function() {
    var r = this;
    Ke.sort(this.events);
    ...
    if (arguments.length === 1) {
      ...
      if (arguments[2] instanceof Qt && V(arguments[0], We) && V(arguments[1], We)) {
        var a = arguments[0], u = arguments[1], l = arguments[2];
        this.addEdges(a, a), this.addEdges(u, u), this.computeIntersections(l);
      } else if (typeof arguments[2] == "boolean" && V(arguments[0], We) && arguments[1] instanceof Qt) {
        var c = arguments[0], f = arguments[1], h = arguments[2];
    ...
    for (var o = this, s = r.getMonotoneChainEdge(), a = s.getStartIndexes(), u = 0; u < a.length - 1; u++) {
      var l = new go(s, u), c = new Ce(i, s.getMinX(u), l);
...
var Ku = { NodeComparator: { configurable: true } };
...
Ar.prototype.toString = function() {
  return He.toLineString(new m(this._min, 0), new m(this._max, 0));
};
Ar.prototype.interfaces_ = function() {
  return [];
};
...
Ku.NodeComparator.get = function() {
  return po;
};
Object.defineProperties(Ar, Ku);
var po = function() {
};
...
var Af = function(n21) {
  function t() {
    n21.call(this), this._item = null;
    var e = arguments[0], r = arguments[1], i = arguments[2];
    this._min = e, this._max = r, this._item = i;
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.query = function(r, i, o) {
...
var Ff = function(n21) {
  function t() {
    n21.call(this), this._node1 = null, this._node2 = null;
    var e = arguments[0], r = arguments[1];
    this._node1 = e, this._node2 = r, this.buildExtent(this._node1, this._node2);
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.buildExtent = function(r, i) {
...
Fr.prototype.buildTree = function() {
  var t = this;
  Ke.sort(this._leaves, new Ar.NodeComparator());
...
Fr.prototype.printNode = function(t) {
  Wt.out.println(He.toLineString(new m(t._min, this._level), new m(t._max, this._level)));
};
...
var ua = { SegmentVisitor: { configurable: true }, IntervalIndexedGeometry: { configurable: true } };
Mi.prototype.locate = function(t) {
  var e = new lr(t), r = new Ai(e);
...
ua.SegmentVisitor.get = function() {
  return Ai;
};
ua.IntervalIndexedGeometry.get = function() {
  return zn;
};
Object.defineProperties(Mi, ua);
var Ai = function() {
  this._counter = null;
  var t = arguments[0];
  this._counter = t;
...
var ji = function(n21) {
  function t() {
    if (n21.call(this), this._parentGeom = null, this._lineEdgeMap = new Du(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = true, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = false, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Je(), arguments.length === 2) {
      var e = arguments[0], r = arguments[1], i = Be.OGC_SFS_BOUNDARY_RULE;
  ...
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.insertBoundaryPoint = function(r, i) {
    ...
    if (arguments.length === 2) {
      var r = arguments[0], i = arguments[1];
      return this.computeSelfNodes(r, i, false);
    } else if (arguments.length === 3) {
      var o = arguments[0], s = arguments[1], a = arguments[2], u = new Qt(o, true, false);
      u.setIsDoneIfProperInt(a);
      var l = this.createEdgeSetIntersector(), c = this._parentGeom instanceof Pr || this._parentGeom instanceof At || this._parentGeom instanceof Lr, f = s || !c;
    ...
    if (i.length < 2)
      return this._hasTooFewPoints = true, this._invalidPoint = i[0], null;
    var o = new Wo(i, new rt(this._argIndex, _.INTERIOR));
    ...
    if (s.length < 4)
      return this._hasTooFewPoints = true, this._invalidPoint = s[0], null;
    var a = i, u = o;
    M.isCCW(s) && (a = o, u = i);
    var l = new Wo(s, new rt(this._argIndex, _.BOUNDARY, a, u));
    ...
    a === null ? s._label = new rt(r, o) : a.setLocation(r, o);
    ...
    if (arguments.length === 1) {
      ...
      if (r.isEmpty())
        return null;
      if (r instanceof Lr && (this._useBoundaryDeterminationRule = false), r instanceof At)
        this.addPolygon(r);
      ...
      return n21.prototype.add.apply(this, arguments);
    ...
    if (arguments.length === 1) {
      ...
      return n21.prototype.findEdge.apply(this, arguments);
  }, t.prototype.interfaces_ = function() {
    return [];
  }, t.prototype.getClass = function() {
    return t;
...
var q = function(n21) {
  function t() {
    var e = arguments[0], r = arguments[1];
    n21.call(this, e, r), this._ptLocator = new Je(), this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new Ze(), this._resultPolyList = new O(), this._resultLineList = new O(), this._resultPointList = new O(), this._graph = new dt(new Vu()), this._geomFact = e.getFactory();
  }
  return n21 && (t.__proto__ = n21), t.prototype = Object.create(n21 && n21.prototype), t.prototype.constructor = t, t.prototype.insertUniqueEdge = function(r) {
    var i = this._edgeList.findEqualEdge(r);
    if (i !== null) {
      var o = i.getLabel(), s = r.getLabel();
      i.isPointwiseEqual(r) || (s = new rt(r.getLabel()), s.flip());
      var a = i.getDepth();
    ...
    for (var r = this._graph.getEdgeEnds().iterator(); r.hasNext(); ) {
      ...
      i.isInResult() && o.isInResult() && (i.setInResult(false), o.setInResult(false));
    }
    ...
    var s = new Er(this, this._geomFact, this._ptLocator);
    ...
    for (var i = this._graph.getEdgeEnds().iterator(); i.hasNext(); ) {
      var o = i.next(), s = o.getLabel();
      s.isArea() && !o.isInteriorAreaEdge() && t.isResultOfOp(s.getLocation(0, P.RIGHT), s.getLocation(1, P.RIGHT), r) && o.setInResult(true);
    }
...
q.overlayOp = function(n21, t, e) {
  var r = new q(n21, t), i = r.getResultGeometry(e);
  return i;
};
q.intersection = function(n21, t) {
  if (n21.isEmpty() || t.isEmpty())
    return q.createEmptyResult(q.INTERSECTION, n21, t, n21.getFactory());
  if (n21.isGeometryCollection()) {
    var e = t;
    return oi.map(n21, {
      interfaces_: function() {
        return [Pn.MapOp];
  ...
  return n21.checkNotGeometryCollection(n21), n21.checkNotGeometryCollection(t), ce.overlayOp(n21, t, q.INTERSECTION);
};
q.symDifference = function(n21, t) {
  if (n21.isEmpty() || t.isEmpty()) {
    if (n21.isEmpty() && t.isEmpty())
      return q.createEmptyResult(q.SYMDIFFERENCE, n21, t, n21.getFactory());
    if (n21.isEmpty())
      return t.copy();
    if (t.isEmpty())
      return n21.copy();
  }
  return n21.checkNotGeometryCollection(n21), n21.checkNotGeometryCollection(t), ce.overlayOp(n21, t, q.SYMDIFFERENCE);
};
q.resultDimension = function(n21, t, e) {
...
q.createEmptyResult = function(n21, t, e, r) {
  var i = null;
  switch (q.resultDimension(n21, t, e)) {
    case -1:
...
q.difference = function(n21, t) {
  return n21.isEmpty() ? q.createEmptyResult(q.DIFFERENCE, n21, t, n21.getFactory()) : t.isEmpty() ? n21.copy() : (n21.checkNotGeometryCollection(n21), n21.checkNotGeometryCollection(t), ce.overlayOp(n21, t, q.DIFFERENCE));
};
q.isResultOfOp = function() {
  if (arguments.length === 2) {
    var n21 = arguments[0], t = arguments[1], e = n21.getLocation(0), r = n21.getLocation(1);
...
q.SYMDIFFERENCE = 4;
var ln = function() {
  this._g = null, this._boundaryDistanceTolerance = null, this._linework = null, this._ptLocator = new Je(), this._seg = new B();
  var t = arguments[0], e = arguments[1];
...
var Te = function n19() {
  this._geom = null, this._locFinder = null, this._location = new Array(3).fill(null), this._invalidLocation = null, this._boundaryDistanceTolerance = n19.TOLERANCE, this._testCoords = new O();
  var t = arguments[0], e = arguments[1], r = arguments[2];
  this._boundaryDistanceTolerance = n19.computeBoundaryDistanceTolerance(t, e), this._geom = [t, e, r], this._locFinder = [new ln(this._geom[0], this._boundaryDistanceTolerance), new ln(this._geom[1], this._boundaryDistanceTolerance), new ln(this._geom[2], this._boundaryDistanceTolerance)];
};
var Zu = { TOLERANCE: { configurable: true } };
...
Te.prototype.checkValid = function() {
  ...
  if (arguments.length === 1) {
    for (var e = arguments[0], r = 0; r < this._testCoords.size(); r++) {
      ...
      if (!t.checkValid(e, i))
        return t._invalidLocation = i, false;
    }
    return true;
  } else if (arguments.length === 2) {
    var o = arguments[0], s = arguments[1];
    return this._location[0] = this._locFinder[0].getLocation(s), this._location[1] = this._locFinder[1].getLocation(s), this._location[2] = this._locFinder[2].getLocation(s), Te.hasLocation(this._location, _.BOUNDARY) ? true : this.isValidResult(o, this._location);
  }
};
...
Object.defineProperties(Te, Zu);
var xe = function n20(t) {
  this._geomFactory = null, this._skipEmpty = false, this._inputGeoms = null, this._geomFactory = n20.extractFactory(t), this._inputGeoms = t;
};
...
var Ju = { STRTREE_NODE_CAPACITY: { configurable: true } };
wt.prototype.reduceToGeometries = function(t) {
  for (var e = this, r = new O(), i = t.iterator(); i.hasNext(); ) {
    var o = i.next(), s = null;
    V(o, We) ? s = e.unionTree(o) : o instanceof z && (s = o), r.add(s);
  }
  return r;
};
...
Ju.STRTREE_NODE_CAPACITY.get = function() {
  return 4;
};
Object.defineProperties(wt, Ju);
var jo = function() {
};
...
Qo.prototype = {
  ...
  add: function(n21) {
    Ha(Oo, n21, this.t), Ha(this, Oo.s, this.s), this.s ? this.t += Oo.t : this.s = Oo.t;
  },
  valueOf: function() {
    return this.s;
  }
...
var Yi = Math.sqrt;
function $u(n21) {
  return n21 > 1 ? 0 : n21 < -1 ? ut : Math.acos(n21);
}
function ui(n21) {
  return n21 > 1 ? jr : n21 < -1 ? -jr : Math.asin(n21);
}
function Qi() {
}
function Ko(n21, t) {
  n21 && Ka.hasOwnProperty(n21.type) && Ka[n21.type](n21, t);
}
var Qa = {
  Feature: function(n21, t) {
    Ko(n21.geometry, t);
  },
  FeatureCollection: function(n21, t) {
    for (var e = n21.features, r = -1, i = e.length; ++r < i; )
      Ko(e[r].geometry, t);
  }
};
var Ka = {
  Sphere: function(n21, t) {
    t.sphere();
  },
  Point: function(n21, t) {
    n21 = n21.coordinates, t.point(n21[0], n21[1], n21[2]);
  },
  MultiPoint: function(n21, t) {
    for (var e = n21.coordinates, r = -1, i = e.length; ++r < i; )
      n21 = e[r], t.point(n21[0], n21[1], n21[2]);
  },
  LineString: function(n21, t) {
    zs(n21.coordinates, t, 0);
  },
  MultiLineString: function(n21, t) {
    for (var e = n21.coordinates, r = -1, i = e.length; ++r < i; )
      zs(e[r], t, 0);
  },
  Polygon: function(n21, t) {
    Za(n21.coordinates, t);
  },
  MultiPolygon: function(n21, t) {
    for (var e = n21.coordinates, r = -1, i = e.length; ++r < i; )
      Za(e[r], t);
  },
  GeometryCollection: function(n21, t) {
    for (var e = n21.geometries, r = -1, i = e.length; ++r < i; )
      Ko(e[r], t);
  }
};
function zs(n21, t, e) {
  var r = -1, i = n21.length - e, o;
  for (t.lineStart(); ++r < i; )
    o = n21[r], t.point(o[0], o[1], o[2]);
  t.lineEnd();
}
function Za(n21, t) {
  var e = -1, r = n21.length;
  for (t.polygonStart(); ++e < r; )
    zs(n21[e], t, 1);
  t.polygonEnd();
}
function kf(n21, t) {
  n21 && Qa.hasOwnProperty(n21.type) ? Qa[n21.type](n21, t) : Ko(n21, t);
}
Wn();
Wn();
function Vs(n21) {
  return [ki(n21[1], n21[0]), ui(n21[2])];
}
function Gi(n21) {
  var t = n21[0], e = n21[1], r = Tt(e);
  return [r * Tt(t), r * Dt(t), Dt(e)];
}
function To(n21, t) {
  return n21[0] * t[0] + n21[1] * t[1] + n21[2] * t[2];
}
function Zo(n21, t) {
  return [n21[1] * t[2] - n21[2] * t[1], n21[2] * t[0] - n21[0] * t[2], n21[0] * t[1] - n21[1] * t[0]];
}
function Ls(n21, t) {
  n21[0] += t[0], n21[1] += t[1], n21[2] += t[2];
}
function Do(n21, t) {
  return [n21[0] * t, n21[1] * t, n21[2] * t];
}
function Us(n21) {
  var t = Yi(n21[0] * n21[0] + n21[1] * n21[1] + n21[2] * n21[2]);
  n21[0] /= t, n21[1] /= t, n21[2] /= t;
}
Wn();
function tl(n21, t) {
  function e(r, i) {
    return r = n21(r, i), t(r[0], r[1]);
  }
  return n21.invert && t.invert && (e.invert = function(r, i) {
    return r = t.invert(r, i), r && n21.invert(r[0], r[1]);
  }), e;
}
function qs(n21, t) {
  return [n21 > ut ? n21 - rn : n21 < -ut ? n21 + rn : n21, t];
}
qs.invert = qs;
function Gf(n21, t, e) {
  return (n21 %= rn) ? t || e ? tl($a(n21), tu(t, e)) : $a(n21) : t || e ? tu(t, e) : qs;
}
function Ja(n21) {
  return function(t, e) {
    return t += n21, [t > ut ? t - rn : t < -ut ? t + rn : t, e];
  };
}
function $a(n21) {
  var t = Ja(n21);
  return t.invert = Ja(-n21), t;
}
function tu(n21, t) {
  var e = Tt(n21), r = Dt(n21), i = Tt(t), o = Dt(t);
  function s(a, u) {
...
function zf(n21, t, e, r, i, o) {
  if (e) {
    var s = Tt(t), a = Dt(t), u = r * e;
    i == null ? (i = t + r * rn, o = t - u / 2) : (i = eu(s, i), o = eu(s, o), (r > 0 ? i < o : i > o) && (i += r * rn));
    for (var l, c = i; r > 0 ? c > o : c < o; c -= u)
      l = Vs([s, -a * Tt(c), -a * Dt(c)]), n21.point(l[0], l[1]);
  }
}
function eu(n21, t) {
  t = Gi(t), t[0] -= n21, Us(t);
...
function el() {
  ...
  return {
    ...
    lineEnd: Qi,
    rejoin: function() {
      n21.length > 1 && n21.push(n21.pop().concat(n21.shift()));
    },
    result: function() {
      var e = n21;
      return n21 = [], t = null, e;
...
function Vf(n21, t, e, r, i, o) {
  var s = n21[0], a = n21[1], u = t[0], l = t[1], c = 0, f = 1, h = u - s, g = l - a, p;
  if (p = e - s, !(!h && p > 0)) {
    if (p /= h, h < 0) {
      if (p < c)
        return;
    ...
    if (p = i - s, !(!h && p < 0)) {
      ...
      if (p = r - a, !(!g && p > 0)) {
        ...
        if (p = o - a, !(!g && p < 0)) {
          ...
          return c > 0 && (n21[0] = s + c * h, n21[1] = a + c * g), f < 1 && (t[0] = s + f * h, t[1] = a + f * g), true;
        }
      }
    }
  }
...
function Go(n21, t) {
  return oe(n21[0] - t[0]) < vt && oe(n21[1] - t[1]) < vt;
}
function Mo(n21, t, e, r) {
  this.x = n21, this.z = t, this.o = e, this.e = r, this.v = false, this.n = this.p = null;
}
function rl(n21, t, e, r, i) {
  var o = [], s = [], a, u;
  if (n21.forEach(function(p) {
    if (!((v = p.length - 1) <= 0)) {
      var v, d = p[0], y = p[v], I;
      if (Go(d, y)) {
      ...
      o.push(I = new Mo(d, p, null, true)), s.push(I.o = new Mo(d, null, I, false)), o.push(I = new Mo(y, p, null, false)), s.push(I.o = new Mo(y, null, I, true));
    }
  }), !!o.length) {
    for (s.sort(t), ru(o), ru(s), a = 0, u = s.length; a < u; ++a)
      s[a].e = e = !e;
    for (var l = o[0], c, f; ; ) {
      for (var h = l, g = true; h.v; )
        if ((h = h.n) === l)
          return;
      c = h.z, i.lineStart();
      do {
...
function ru(n21) {
  if (t = n21.length) {
    for (var t, e = 0, r = n21[0], i; ++e < t; )
      r.n = i = n21[e], i.p = r, r = i;
    r.n = i = n21[0], i.p = r;
  }
}
function nl(n21, t) {
  return n21 < t ? -1 : n21 > t ? 1 : n21 >= t ? 0 : NaN;
}
function Uf(n21) {
  return n21.length === 1 && (n21 = qf(n21)), {
    left: function(t, e, r, i) {
      for (r == null && (r = 0), i == null && (i = t.length); r < i; ) {
        var o = r + i >>> 1;
        n21(t[o], e) < 0 ? r = o + 1 : i = o;
      }
      return r;
    },
...
Uf(nl);
function il(n21) {
  for (var t = n21.length, e, r = -1, i = 0, o, s; ++r < t; )
    i += n21[r].length;
  for (o = new Array(i); --t >= 0; )
    for (s = n21[t], e = s.length; --e >= 0; )
      o[--i] = s[e];
  return o;
}
var Ki = 1e9;
var Ao = -Ki;
function Xf(n21, t, e, r) {
  function i(l, c) {
    return n21 <= l && l <= e && t <= c && c <= r;
  }
  function o(l, c, f, h) {
    var g = 0, p = 0;
    if (l == null || (g = s(l, f)) !== (p = s(c, f)) || u(l, c) < 0 ^ f > 0)
      do
        h.point(g === 0 || g === 3 ? n21 : e, g > 1 ? r : t);
      while ((g = (g + f + 4) % 4) !== p);
    else
      h.point(c[0], c[1]);
  }
  function s(l, c) {
    return oe(l[0] - n21) < vt ? c > 0 ? 0 : 3 : oe(l[0] - e) < vt ? c > 0 ? 2 : 1 : oe(l[1] - t) < vt ? c > 0 ? 1 : 0 : c > 0 ? 3 : 2;
  }
  function a(l, c) {
    return u(l.x, c.x);
  }
  ...
  return function(l) {
    var c = l, f = el(), h, g, p, v, d, y, I, C, N, L, T, R = {
      point: D,
      lineStart: G,
      lineEnd: at,
      polygonStart: A,
    ...
    function b() {
      for (var k = 0, Q = 0, _t = g.length; Q < _t; ++Q)
        for (var Kt = g[Q], zt = 1, kr = Kt.length, Ie = Kt[0], De, Ue, In = Ie[0], sn = Ie[1]; zt < kr; ++zt)
          De = In, Ue = sn, Ie = Kt[zt], In = Ie[0], sn = Ie[1], Ue <= r ? sn > r && (In - De) * (r - Ue) > (sn - Ue) * (n21 - De) && ++k : sn <= r && (In - De) * (r - Ue) < (sn - Ue) * (n21 - De) && --k;
      return k;
    }
    function A() {
      c = f, h = [], g = [], T = true;
    ...
    function Y() {
      var k = b(), Q = T && k, _t = (h = il(h)).length;
      (Q || _t) && (l.polygonStart(), Q && (l.lineStart(), o(null, null, 1, l), l.lineEnd()), _t && rl(h, a, k, o, l), l.polygonEnd()), c = l, h = g = p = null;
    }
    function G() {
      R.point = x, g && g.push(p = []), L = true, N = false, I = C = NaN;
    }
    function at() {
      h && (x(v, d), y && N && f.rejoin(), h.push(f.result())), R.point = D, N && c.lineEnd();
    }
    function x(k, Q) {
      var _t = i(k, Q);
      if (g && p.push([k, Q]), L)
        v = k, d = Q, y = _t, L = false, _t && (c.lineStart(), c.point(k, Q));
      else if (_t && N)
        c.point(k, Q);
      else {
        var Kt = [I = Math.max(Ao, Math.min(Ki, I)), C = Math.max(Ao, Math.min(Ki, C))], zt = [k = Math.max(Ao, Math.min(Ki, k)), Q = Math.max(Ao, Math.min(Ki, Q))];
        Vf(Kt, zt, n21, t, e, r) ? (N || (c.lineStart(), c.point(Kt[0], Kt[1])), c.point(zt[0], zt[1]), _t || c.lineEnd(), T = false) : _t && (c.lineStart(), c.point(k, Q), T = false);
      }
      I = k, C = Q, N = _t;
    }
    return R;
...
function Yf(n21, t) {
  ...
  bs.reset();
  for (var a = 0, u = n21.length; a < u; ++a)
    if (c = (l = n21[a]).length)
      for (var l, c, f = l[c - 1], h = f[0], g = f[1] / 2 + ja, p = Dt(g), v = Tt(g), d = 0; d < c; ++d, h = I, p = N, v = L, f = y) {
        var y = l[d], I = y[0], C = y[1] / 2 + ja, N = Dt(C), L = Tt(C), T = I - h, R = T >= 0 ? 1 : -1, D = R * T, b = D > ut, A = p * N;
        if (bs.add(ki(A * R * Dt(D), v * L + A * Tt(D))), o += b ? T + R * rn : T, b ^ h >= e ^ I >= e) {
          var Y = Zo(Gi(f), Gi(y));
          Us(Y);
          var G = Zo(i, Y);
          Us(G);
...
var iu = {
  ...
  result: function() {
    var n21 = [[zi, Jo], [vo, $o]];
    return vo = $o = -(Jo = zi = 1 / 0), n21;
  }
};
function Wf(n21, t) {
  n21 < zi && (zi = n21), n21 > vo && (vo = n21), t < Jo && (Jo = t), t > $o && ($o = t);
}
Wn();
function ol(n21, t, e, r) {
  return function(i, o) {
    var s = t(o), a = i.invert(r[0], r[1]), u = el(), l = t(u), c = false, f, h, g, p = {
      point: v,
      lineStart: y,
      lineEnd: I,
      ...
      polygonEnd: function() {
        p.point = v, p.lineStart = y, p.lineEnd = I, h = il(h);
        var T = Yf(f, a);
        h.length ? (c || (o.polygonStart(), c = true), rl(h, jf, T, e, o)) : T && (c || (o.polygonStart(), c = true), o.lineStart(), e(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = false), h = f = null;
      },
      sphere: function() {
      ...
      if (g.pop(), f.push(g), g = null, !!b) {
        if (T & 1) {
          if (Y = R[0], (A = Y.length - 1) > 0) {
            for (c || (o.polygonStart(), c = true), o.lineStart(), D = 0; D < A; ++D)
              o.point((G = Y[D])[0], G[1]);
            o.lineEnd();
          }
          return;
...
function jf(n21, t) {
  return ((n21 = n21.x)[0] < 0 ? n21[1] - jr - vt : jr - n21[1]) - ((t = t.x)[0] < 0 ? t[1] - jr - vt : jr - t[1]);
}
var ou = ol(
  function() {
    return true;
...
function Qf(n21) {
  ...
  return {
    ...
    point: function(o, s) {
      ...
      oe(u - ut) < vt ? (n21.point(t, e = (e + s) / 2 > 0 ? jr : -jr), n21.point(r, e), n21.lineEnd(), n21.lineStart(), n21.point(a, e), n21.point(o, e), i = 0) : r !== a && u >= ut && (oe(t - r) < vt && (t -= r * vt), oe(o - a) < vt && (o -= a * vt), e = Kf(t, e, o, s), n21.point(r, e), n21.lineEnd(), n21.lineStart(), n21.point(a, e), i = 0), n21.point(t = o, e = s), r = a;
    },
    lineEnd: function() {
      n21.lineEnd(), t = e = NaN;
    },
...
function Kf(n21, t, e, r) {
  var i, o, s = Dt(n21 - e);
  return oe(s) > vt ? Bf((Dt(t) * (o = Tt(r)) * Dt(e) - Dt(r) * (i = Tt(t)) * Dt(n21)) / (i * o * s)) : (t + r) / 2;
}
function Zf(n21, t, e, r) {
  var i;
  if (n21 == null)
    i = e * jr, r.point(-ut, i), r.point(0, i), r.point(ut, i), r.point(ut, 0), r.point(ut, -i), r.point(0, -i), r.point(-ut, -i), r.point(-ut, 0), r.point(-ut, i);
  else if (oe(n21[0] - t[0]) > vt) {
    var o = n21[0] < t[0] ? ut : -ut;
    i = e * o / 2, r.point(-o, i), r.point(0, i), r.point(o, i);
  } else
    r.point(t[0], t[1]);
}
function Jf(n21, t) {
  var e = Tt(n21), r = e > 0, i = oe(e) > vt;
  function o(c, f, h, g) {
    zf(g, n21, t, h, c, f);
  }
  function s(c, f) {
  ...
  function a(c) {
    ...
    return {
      ...
      point: function(d, y) {
        var I = [d, y], C, N = s(d, y), L = r ? N ? 0 : l(d, y) : N ? l(d + (d < 0 ? ut : -ut), y) : 0;
        if (!f && (p = g = N) && c.lineStart(), N !== g && (C = u(f, I), (!C || Go(f, C) || Go(I, C)) && (I[0] += vt, I[1] += vt, N = s(I[0], I[1]))), N !== g)
          v = 0, N ? (c.lineStart(), C = u(I, f), c.point(C[0], C[1])) : (C = u(f, I), c.point(C[0], C[1]), c.lineEnd()), f = C;
        else if (i && f && r ^ N) {
          var T;
          !(L & h) && (T = u(I, f, true)) && (v = 0, r ? (c.lineStart(), c.point(T[0][0], T[0][1]), c.point(T[1][0], T[1][1]), c.lineEnd()) : (c.point(T[1][0], T[1][1]), c.lineEnd(), c.lineStart(), c.point(T[0][0], T[0][1])));
        }
        N && (!f || !Go(f, I)) && c.point(I[0], I[1]), f = I, g = N, h = L;
      },
      lineEnd: function() {
        g && c.lineEnd(), f = null;
      },
  ...
  function u(c, f, h) {
    var g = Gi(c), p = Gi(f), v = [1, 0, 0], d = Zo(g, p), y = To(d, d), I = d[0], C = y - I * I;
    if (!C)
      return !h && c;
    var N = e * y / C, L = -e * I / C, T = Zo(v, d), R = Do(v, N), D = Do(d, L);
    Ls(R, D);
    var b = T, A = To(R, b), Y = To(b, b), G = A * A - Y * (To(R, R) - 1);
    if (!(G < 0)) {
      var at = Yi(G), x = Do(b, (-A - at) / Y);
      if (Ls(x, R), x = Vs(x), !h)
        return x;
      var k = c[0], Q = f[0], _t = c[1], Kt = f[1], zt;
      Q < k && (zt = k, k = Q, Q = zt);
      var kr = Q - k, Ie = oe(kr - ut) < vt, De = Ie || kr < vt;
      if (!Ie && Kt < _t && (zt = _t, _t = Kt, Kt = zt), De ? Ie ? _t + Kt > 0 ^ x[1] < (oe(x[0] - k) < vt ? _t : Kt) : _t <= x[1] && x[1] <= Kt : kr > ut ^ (k <= x[0] && x[0] <= Q)) {
        var Ue = Do(b, (-A + at) / Y);
        return Ls(Ue, R), [x, Vs(Ue)];
      }
    }
  }
  function l(c, f) {
    var h = r ? n21 : ut - n21, g = 0;
    return c < -h ? g |= 1 : c > h && (g |= 2), f < -h ? g |= 4 : f > h && (g |= 8), g;
  }
  return ol(s, a, o, r ? [0, -n21] : [-ut, n21 - ut]);
}
function sl(n21) {
  return function(t) {
    var e = new Xs();
...
function al(n21, t, e) {
  var r = t[1][0] - t[0][0], i = t[1][1] - t[0][1], o = n21.clipExtent && n21.clipExtent();
  n21.scale(150).translate([0, 0]), o != null && n21.clipExtent(null), kf(e, n21.stream(iu));
  var s = iu.result(), a = Math.min(r / (s[1][0] - s[0][0]), i / (s[1][1] - s[0][1])), u = +t[0][0] + (r - a * (s[1][0] + s[0][0])) / 2, l = +t[0][1] + (i - a * (s[1][1] + s[0][1])) / 2;
  return o != null && n21.clipExtent(o), n21.scale(a * 150).translate([u, l]);
}
function $f(n21, t, e) {
  return al(n21, [[0, 0], t], e);
}
var su = 16;
var th = Tt(30 * or);
function au(n21, t) {
  return +t ? rh(n21, t) : eh(n21);
}
function eh(n21) {
  return sl({
    point: function(t, e) {
      t = n21(t, e), this.stream.point(t[0], t[1]);
    }
  });
}
function rh(n21, t) {
  function e(r, i, o, s, a, u, l, c, f, h, g, p, v, d) {
    var y = l - r, I = c - i, C = y * y + I * I;
    if (C > 4 * t && v--) {
      var N = s + h, L = a + g, T = u + p, R = Yi(N * N + L * L + T * T), D = ui(T /= R), b = oe(oe(T) - 1) < vt || oe(o - f) < vt ? (o + f) / 2 : ki(L, N), A = n21(b, D), Y = A[0], G = A[1], at = Y - r, x = G - i, k = I * at - y * x;
      (k * k / C > t || oe((y * at + I * x) / C - 0.5) > 0.3 || s * h + a * g + u * p < th) && (e(r, i, o, s, a, u, Y, G, b, N /= R, L /= R, T, v, d), d.point(Y, G), e(Y, G, b, N, L, T, l, c, f, h, g, p, v, d));
    }
  }
  return function(r) {
    ...
    function y(D, b) {
      D = n21(D, b), r.point(D[0], D[1]);
    }
    function I() {
      f = NaN, d.point = C, r.lineStart();
    }
    function C(D, b) {
      var A = Gi([D, b]), Y = n21(D, b);
      e(f, h, c, g, p, v, f = Y[0], h = Y[1], c = D, g = A[0], p = A[1], v = A[2], su, r), r.point(f, h);
    }
    function N() {
      d.point = y, r.lineEnd();
    }
    ...
    function R() {
      e(f, h, c, g, p, v, o, s, i, a, u, l, su, r), d.lineEnd = N, N();
    }
    return d;
  };
}
...
function oh(n21) {
  var t, e = 150, r = 480, i = 250, o, s, a = 0, u = 0, l = 0, c = 0, f = 0, h, g, p = null, v = ou, d = null, y, I, C, N = nu, L = 0.5, T = au(Y, L), R, D;
  function b(x) {
    return x = g(x[0] * or, x[1] * or), [x[0] * e + o, s - x[1] * e];
  }
  function A(x) {
    return x = g.invert((x[0] - o) / e, (s - x[1]) / e), x && [x[0] * xn, x[1] * xn];
  }
  function Y(x, k) {
    return x = t(x, k), [x[0] * e + o, s - x[1] * e];
  }
  b.stream = function(x) {
    return R && D === x ? R : R = nh(v(h, T(N(D = x))));
  }, b.clipAngle = function(x) {
    return arguments.length ? (v = +x ? Jf(p = x * or, 6 * or) : (p = null, ou), at()) : p * xn;
  }, b.clipExtent = function(x) {
    return arguments.length ? (N = x == null ? (d = y = I = C = null, nu) : Xf(d = +x[0][0], y = +x[0][1], I = +x[1][0], C = +x[1][1]), at()) : d == null ? null : [[d, y], [I, C]];
  }, b.scale = function(x) {
    return arguments.length ? (e = +x, G()) : e;
  }, b.translate = function(x) {
    return arguments.length ? (r = +x[0], i = +x[1], G()) : [r, i];
  }, b.center = function(x) {
    return arguments.length ? (a = x[0] % 360 * or, u = x[1] % 360 * or, G()) : [a * xn, u * xn];
  }, b.rotate = function(x) {
    return arguments.length ? (l = x[0] % 360 * or, c = x[1] % 360 * or, f = x.length > 2 ? x[2] % 360 * or : 0, G()) : [l * xn, c * xn, f * xn];
  }, b.precision = function(x) {
    return arguments.length ? (T = au(Y, L = x * x), at()) : Yi(L);
  ...
  return function() {
    return t = n21.apply(this, arguments), b.invert = t.invert && A, G();
  };
}
function ul(n21) {
  return function(t, e) {
    var r = Tt(t), i = Tt(e), o = n21(r * i);
    return [
      o * i * Dt(t),
      o * Dt(e)
    ];
...
function ll(n21) {
  return function(t, e) {
    var r = Yi(t * t + e * e), i = n21(r), o = Dt(i), s = Tt(i);
    return [
      ki(t * o, r * s),
      ui(r && e * o / r)
    ];
...
var sh = ul(function(n21) {
  return Yi(2 / (1 + n21));
});
sh.invert = ll(function(n21) {
  return 2 * ui(n21 / 2);
});
var cl = ul(function(n21) {
  return (n21 = $u(n21)) && n21 / Dt(n21);
});
cl.invert = ll(function(n21) {
  return n21;
});
function ah() {
  return ih(cl).scale(79.4188).clipAngle(180 - 1e-3);
}
function uu(n21, t) {
  return [n21, t];
}
...
function uh(n21, t, e) {
  ...
  switch (n21.type) {
    case "GeometryCollection":
      return xu(n21, function(s) {
        var a = zo(s, t, r, i);
        a && o.push(a);
      }), Bs(o);
    case "FeatureCollection":
      return Ua(n21, function(s) {
        var a = zo(s, t, r, i);
        a && Ua(a, function(u) {
          u && o.push(u);
        });
...
function zo(n21, t, e, r) {
  var i = n21.properties || {}, o = n21.type === "Feature" ? n21.geometry : n21;
  if (o.type === "GeometryCollection") {
    var s = [];
    return xu(n21, function(v) {
      var d = zo(v, t, e, r);
      d && s.push(d);
    }), Bs(s);
  }
  var a = lh(o), u = {
    type: o.type,
    coordinates: hl(o.coordinates, a)
  }, l = new ta(), c = l.read(u), f = vf(mf(t, e), "meters"), h = Xt.bufferOp(c, f, r), g = new Au();
  if (h = g.write(h), !fl(h.coordinates)) {
    var p = {
      type: h.type,
      coordinates: gl(h.coordinates, a)
    };
    return ts(p, i);
  }
}
function fl(n21) {
  return Array.isArray(n21[0]) ? fl(n21[0]) : isNaN(n21[0]);
}
function hl(n21, t) {
  return typeof n21[0] != "object" ? t(n21) : n21.map(function(e) {
    return hl(e, t);
  });
}
function gl(n21, t) {
  return typeof n21[0] != "object" ? t.invert(n21) : n21.map(function(e) {
    return gl(e, t);
  });
}
function lh(n21) {
  var t = _f(n21).geometry.coordinates, e = [-t[0], -t[1]];
  return ah().rotate(e).scale(Ne);
}
function ch(n21, t) {
  var e = qo(n21), r = qo(t), i = n21.properties || {}, o = Eu.difference(
    e.coordinates,
    r.coordinates
  );
  return o.length === 0 ? null : o.length === 1 ? Iu(o[0], i) : Nu(o, i);
}
function lu(n21) {
  let t;
  for (const e of n21)
...
function fh(n21, t, e = true, r = true, i = {}, o = {}, s = {
  fill: {
    paint: {
      "fill-color": "#000",
      "fill-opacity": 0.1
  ...
  let a, u = [], l, c;
  function f() {
    (s != null && s.fill || s != null && s.line) && n21.addSource("full-geom", {
      type: "geojson",
      data: fu
    }), s != null && s.fill && n21.addLayer({
      ...s == null ? void 0 : s.fill,
      id: "full-geom-fill",
      type: "fill",
      source: "full-geom"
    }), s != null && s.line && n21.addLayer({
  ...
  function g(p = false) {
    ...
    return p && v.classList.add("marker-interactive"), new Cc({
  ...
  return {
    setEventHandler(p) {
      p ? (a = p, n21.on("click", h)) : (a = void 0, n21.off("click", h));
    },
    flyTo(p, v) {
      n21.flyTo({ center: p, zoom: v, ...i });
    },
    fitBounds(p, v, d) {
      n21.fitBounds(
        [
    ...
    indicateReverse(p) {
      n21.getCanvasContainer().style.cursor = p ? "crosshair" : "";
    },
    setReverseMarker(p) {
      !t || !e || (c ? p ? c.setLngLat(p) : (c.remove(), c = void 0) : p && (c = (typeof e == "object" ? new t.Marker(e) : g()).setLngLat(p).addTo(n21), c.getElement().classList.add("marker-reverse")));
    },
    setMarkers(p, v) {
      if (!e)
        return;
      function d(y) {
        var I;
        (I = n21.getSource("full-geom")) == null || I.setData(y);
      }
      for (const y of u)
        y.remove();
      if (u.length = 0, d(fu), !!t) {
        if (v) {
          let y = false;
          ...
          e && u.push(
            (typeof e == "object" ? new t.Marker(e) : g()).setLngLat(v.center).addTo(n21)
          );
        }
        if (r)
          for (const y of p ?? []) {
            if (y === v)
              continue;
            const I = (typeof r == "object" ? new t.Marker(r) : g(true)).setLngLat(y.center).setPopup(
              new t.Popup({
                offset: [1, -27],
                closeButton: false,
                closeOnMove: true,
    ...
    setSelectedMarker(p) {
      l && l.getElement().classList.toggle("marker-selected", false), l = p > -1 ? u[p] : void 0, l == null || l.getElement().classList.toggle("marker-selected", true);
    },
    getCenterAndZoom() {
      const p = n21.getCenter();
      return [n21.getZoom(), p.lng, p.lat];
    }
  };
}
var qe;
var Qn;
var hh = class extends EventTarget {
  constructor(e = {}) {
    super();
    Is(this, qe, void 0);
    Is(this, Qn, void 0);
  ...
  onAdd(e) {
    ...
    const {
      ...
      fullGeometryStyle: a,
      ...u
    } = nr(this, Qn), l = typeof s == "boolean" ? {} : s, c = this.getExtraProps(e, r), h = {
      mapController: fh(
        e,
        this.getMapLibreGl(),
        i,
    ...
    wo(this, qe, new Yc({ target: r, props: h }));
    for (const g of [
      "select",
      "pick",
      "featuresListed",
      ...
      nr(this, qe).$on(g, (p) => this.dispatchEvent(p));
    return r;
  }
  setOptions(e) {
    var u;
    ...
    (u = nr(this, qe)) == null || u.$set(a);
  }
  setQuery(e, r = true) {
    var i;
    (i = nr(this, qe)) == null || i.setQuery(e, r);
  }
  clearMap() {
    var e;
    (e = nr(this, qe)) == null || e.clearMap();
  }
  clearList() {
    var e;
    (e = nr(this, qe)) == null || e.clearList();
  }
  setReverseMode(e) {
    var r;
    (r = nr(this, qe)) == null || r.$set({ reverseActive: e });
  }
  focus() {
    var e;
    (e = nr(this, qe)) == null || e.focus();
  }
  blur() {
    var e;
    (e = nr(this, qe)) == null || e.blur();
  }
  onRemove() {
    var e;
    (e = nr(this, qe)) == null || e.$destroy();
  }
};
qe = /* @__PURE__ */ new WeakMap(), Qn = /* @__PURE__ */ new WeakMap();
...
export {
  dh as GeocodingControl,
  fh as createMapLibreGlMapController
};
/*! Bundled license information:

@maptiler/geocoding-control/maplibregl.js:
  (**
   * splaytree v3.1.2
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=@maptiler_geocoding-control_maplibregl.js.map
